...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/sum/sum.py | tail -n 1)
echo ""
...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/float/float.py | tail -n 1)
echo ""
...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/go/go.hs | tail -n 1)
echo ""
...
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/nbody/nbody.py 1000000 | tail -n 1)
echo ""
...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/chaos/chaos.hs /dev/null | tail -n 1)
echo ""
...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/spectral_norm/spectral_norm.py | tail -n 1)
echo ""
...
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/set_partition/set_partition.py 15 | tail -n 1)
echo ""
...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/primes/primes.hs 30000 | tail -n 1)
echo ""
...
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/binary_trees/binary_trees.hs 20 | tail -n 1)
echo ""
...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/fannkuch/fannkuch.hs 11 | tail -n 1)
echo ""
...
if [[ ! -z "${DATA_WORD_COUNT}" ]]; then
  ...
  echo -n ","
  echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/word_count/word_count.py $DATA_WORD_COUNT | tail -n 1)
  echo ""
fi
...
if [[ ! -z "${DATA_TAQ}" ]]; then
  ...
  echo -n ","
  echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/taq/taq.py $DATA_TAQ | tail -n 1)
  echo ""
fi
...
# nothing for cpp
echo -n ","
echo -n $(${HERCULES} run -m 1 ${BENCH_DIR}/mandelbrot/mandelbrot.hs | tail -n 1)
echo ""