...
#include <collie/type_safe/detail/variant_impl.h>
...
public:
    ...
    {
        return has_value() ? nullptr : collie::ts::opt_ref(&nullvar);
    }
    ...
    {
        return has_value(type) ? collie::ts::opt_ref(&storage_.get_union().value(type)) : nullptr;
    }
    ...
    {
        return has_value(type) ? collie::ts::opt_xref(&storage_.get_union().value(type)) : nullptr;
    }
