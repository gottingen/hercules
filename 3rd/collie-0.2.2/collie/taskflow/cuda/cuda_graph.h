...
#include <collie/taskflow/cuda/cuda_memory.h>
#include <collie/taskflow/cuda/cuda_stream.h>
#include <collie/taskflow/cuda/cuda_meta.h>
...
class cudaFlowNode {
  ...
  private:
    ...
    InlinedVector<cudaFlowNode*> _successors;
    InlinedVector<cudaFlowNode*> _dependents;
