...
#include <collie/taskflow/core/graph.h>
...
namespace collie::tf {
    ...
    */
    ...
    or std::function<int(collie::tf::Runtime&)>.
    */
    template<typename C>
    ...
    std::function<collie::InlinedVector<int>()> or
    std::function<collie::InlinedVector<int>(collie::tf::Runtime&)>.
    */
    template<typename C>
    constexpr bool is_multi_condition_task_v =
            (std::is_invocable_r_v<InlinedVector<int>, C> ||
             std::is_invocable_r_v<InlinedVector<int>, C, Runtime &>) &&
            !is_subflow_task_v<C>;
    ...
    or std::function<void(collie::tf::Runtime&)>.
    */
    template<typename C>
    ...
    */
    ...
    public:
        ...
        */
        ...
        collie::tf::TaskPriority::HIGH (numerically equivalent to 0),
        collie::tf::TaskPriority::NORMAL (numerically equivalent to 1), and
        collie::tf::TaskPriority::LOW (numerically equivalent to 2).
