...
*/
    ...
    public:
        ...
        */
        ...
        @return a collie::tf::Future that will holds the result of the execution

        The method creates an asynchronous task to launch the given
        function on the given arguments.
        Unlike std::async, the return here is a @em collie::tf::Future that holds
        ...
        @code{.cpp}
        collie::tf::Future<std::optional<int>> future = executor.async([](){
        ...
        */
        ...
        Unlike std::async, the return here is a collie::tf::Future that holds
        an optional object to the result.
        If the asynchronous task is cancelled before it runs, the return is
        a @c std::nullopt, or the value returned by the callable.

        @code{.cpp}
        collie::tf::Future<std::optional<int>> future = executor.named_async("name", [](){
        ...
        */
        ...
        /**
        @brief similar to collie::tf::Executor::named_async but does not return a future object

        This member function is more efficient than collie::tf::Executor::named_async
        and is encouraged to use when there is no data returned.
...
// Procedure: _schedule
    inline void Executor::_schedule(
            Worker &worker, const InlinedVector<Node *> &nodes
    ) {
...
// Function: run_until
    ...
    collie::tf::Future<void> Executor::run_until(Taskflow &f, P &&p, C &&c) {
        ...
        if (empty || p()) {
            ...
            promise.set_value();
            _decrement_topology_and_notify();
            return collie::tf::Future<void>(promise.get_future(), std::monostate{});
        }
