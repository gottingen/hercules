...
#ifndef COLLIE_SIMD_ARCH_SVE_H_
#define COLLIE_SIMD_ARCH_SVE_H_
...
namespace collie::simd {
    ...
    namespace kernel {
        namespace detail {
            using collie::simd::index;
            using collie::simd::types::detail::sve_vector_type;
            ...
            template<class T>
            using sve_enable_signed_int_t = typename std::enable_if<
                    std::is_integral<T>::value && std::is_signed<T>::value, int>::type;

            // enable for unsigned integers
            template<class T>
            using sve_enable_unsigned_int_t = typename std::enable_if<
                    std::is_integral<T>::value && !std::is_signed<T>::value, int>::type;
        ...
        load_complex_aligned(std::complex<T> const *mem, convert<std::complex<T>>, requires_arch<sve>) noexcept {
        ...
        template<class A, class T, detail::sve_enable_floating_point_t<T> = 0>
        inline batch <std::complex<T>, A>
        load_complex_unaligned(std::complex<T> const *mem, convert<std::complex<T>>, requires_arch<sve>) noexcept {
        ...
        // store_complex
        template<class A, class T, detail::sve_enable_floating_point_t<T> = 0>
        inline void store_complex_aligned(std::complex<T> *dst, batch <std::complex<T>, A> const &src,
        ...
        template<class A, class T, detail::sve_enable_floating_point_t<T> = 0>
        inline void store_complex_unaligned(std::complex<T> *dst, batch <std::complex<T>, A> const &src,
                                            requires_arch<sve>) noexcept {
        ...
        namespace detail {
            ...
            using sve_enable_sg_t = typename std::enable_if<(sizeof(T) == sizeof(U) &&
                                                             (sizeof(T) == 4 || sizeof(T) == 8)), int>::type;
        }

        // scatter
        template<class A, class T, class U, detail::sve_enable_sg_t<T, U> = 0>
        inline void scatter(batch < T, A >
        const& src,
        T *dst, batch<U, A>
        const& index, kernel::requires_arch<sve>) noexcept {
        svst1_scatter_index(detail::sve_ptrue<T>(), dst, index
    ...
    // gather
    template<class A, class T, class U, detail::sve_enable_sg_t<T, U> = 0>
    inline batch <T, A> gather(batch < T, A >
    const&,
    T const *src, batch<U, A>
    const& index, kernel::requires_arch<sve>) noexcept {
    return

    svld1_gather_index(detail::sve_ptrue<T>(), src, index
...
const& lhs,
batch <T, A> const &rhs, requires_arch<sve>
) noexcept
{
return

svadd_x(detail::sve_ptrue<T>(), lhs, rhs
...
svsub_x(detail::sve_ptrue<T>(), lhs, rhs
...
// mul
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch <T, A> mul(batch < T, A >
const& lhs,
batch <T, A> const &rhs, requires_arch<sve>
) noexcept
{
...
svmul_x(detail::sve_ptrue<T>(), lhs, rhs
...
inline batch <T, A> div(batch < T, A >
const& lhs,
batch <T, A> const &rhs, requires_arch<sve>
) noexcept
{
...
svdiv_x(detail::sve_ptrue<T>(), lhs, rhs
...
svmax_x(detail::sve_ptrue<T>(), lhs, rhs
...
svmin_x(detail::sve_ptrue<T>(), lhs, rhs
...
const& arg, requires_arch <sve>) noexcept
{
return

svreinterpret_u8 (svneg_x(detail::sve_ptrue<T>(), svreinterpret_s8(arg)));
...
svreinterpret_u16 (svneg_x(detail::sve_ptrue<T>(), svreinterpret_s16(arg)));
...
svreinterpret_u32 (svneg_x(detail::sve_ptrue<T>(), svreinterpret_s32(arg)));
...
svreinterpret_u64 (svneg_x(detail::sve_ptrue<T>(), svreinterpret_s64(arg)));
...
svneg_x(detail::sve_ptrue<T>(), arg
...
svabs_x(detail::sve_ptrue<T>(), arg
...
// fma: x * y + z
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch <T, A> fma(batch < T, A >
const& x,
batch <T, A> const &y, batch<T, A>
const& z, requires_arch <sve>) noexcept
{
return

svmad_x(detail::sve_ptrue<T>(), x, y, z
...
// fnma: z - x * y
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch <T, A> fnma(batch < T, A >
const& x,
batch <T, A> const &y, batch<T, A>
const& z, requires_arch <sve>) noexcept
{
...
svmsb_x(detail::sve_ptrue<T>(), x, y, z
...
// fms: x * y - z
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch <T, A> fms(batch < T, A >
const& x,
batch <T, A> const &y, batch<T, A>
const& z, requires_arch <sve>) noexcept
{
...
// fnms: - x * y - z
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch <T, A> fnms(batch < T, A >
const& x,
batch <T, A> const &y, batch<T, A>
const& z, requires_arch <sve>) noexcept
{
...
svand_x(detail::sve_ptrue<T>(), lhs, rhs
...
const& lhs,
batch<float, A> const &rhs, requires_arch<sve>
) noexcept
{
...
return
svreinterpret_f32(result_bits);
}

template<class A>
inline batch<double, A> bitwise_and(batch < double, A >
const& lhs,
batch<double, A> const &rhs, requires_arch<sve>
) noexcept
{
...
return
svreinterpret_f64(result_bits);
}

template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch_bool <T, A> bitwise_and(batch_bool < T, A >
const& lhs,
batch_bool <T, A> const &rhs, requires_arch<sve>
) noexcept
{
return

svand_z(detail::sve_ptrue<T>(), lhs, rhs
...
svbic_x(detail::sve_ptrue<T>(), lhs, rhs
...
svbic_z(detail::sve_ptrue<T>(), lhs, rhs
...
svorr_x(detail::sve_ptrue<T>(), lhs, rhs
...
svorr_z(detail::sve_ptrue<T>(), lhs, rhs
...
sveor_x(detail::sve_ptrue<T>(), lhs, rhs
...
sveor_z(detail::sve_ptrue<T>(), lhs, rhs
...
svnot_x(detail::sve_ptrue<T>(), arg
...
svnot_z(detail::sve_ptrue<T>(), arg
...
namespace detail {
    ...
    inline batch <U, A> sve_to_unsigned_batch_impl(batch < T, A >
    const& arg, index<1>) noexcept {
    return
    svreinterpret_u8(arg);
}

template<class A, class T, class U>
inline batch <U, A> sve_to_unsigned_batch_impl(batch < T, A >
const& arg, index<2>) noexcept
{
return
svreinterpret_u16(arg);
}

template<class A, class T, class U>
inline batch <U, A> sve_to_unsigned_batch_impl(batch < T, A >
const& arg, index<4>) noexcept
{
return
svreinterpret_u32(arg);
}

template<class A, class T, class U>
inline batch <U, A> sve_to_unsigned_batch_impl(batch < T, A >
const& arg, index<8>) noexcept
{
return
svreinterpret_u64(arg);
}

template<class A, class T, class U = as_unsigned_integer_t <T>>
inline batch <U, A> sve_to_unsigned_batch(batch < T, A >
const& arg) noexcept
{
return
sve_to_unsigned_batch_impl<A, T, U>(arg, index<sizeof(T)> {}
);
}
} // namespace detail
...
const& arg,
int n, requires_arch<sve>
) noexcept
{
constexpr std::size_t size = sizeof(typename batch<T, A>::value_type) * 8;
assert(0 <= n && static_cast
<std::size_t>(n)
< size && "index in bounds");
return

svlsl_x(detail::sve_ptrue<T>(), arg, n
...
svlsl_x(detail::sve_ptrue<T>(), lhs, detail::sve_to_unsigned_batch<A, T>(rhs)
...
svlsr_x(detail::sve_ptrue<T>(), arg,
...
svlsr_x(detail::sve_ptrue<T>(), lhs, rhs
...
svasr_x(detail::sve_ptrue<T>(), arg,

static_cast
<as_unsigned_integer_t<T>>(n)
);
}
...
svasr_x(detail::sve_ptrue<T>(), lhs, detail::sve_to_unsigned_batch<A, T>(rhs)
...
inline V reduce_add(batch < T, A >
const& arg, requires_arch <sve>) noexcept
{
// sve integer reduction results are promoted to 64 bits
return static_cast
<V>(svaddv(detail::sve_ptrue<T>(), arg)
);
}

// reduce_max
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline T reduce_max(batch < T, A >
const& arg, requires_arch <sve>) noexcept
{
return

svmaxv(detail::sve_ptrue<T>(), arg
...
// reduce_min
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline T reduce_min(batch < T, A >
const& arg, requires_arch <sve>) noexcept
{
return

svminv(detail::sve_ptrue<T>(), arg
...
svcmpeq(detail::sve_ptrue<T>(), lhs, rhs
...
svnot_z(detail::sve_ptrue<T>(), neq_result
...
svcmpne(detail::sve_ptrue<T>(), lhs, rhs
...
svcmplt(detail::sve_ptrue<T>(), lhs, rhs
...
// le
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch_bool <T, A> le(batch < T, A >
const& lhs,
batch <T, A> const &rhs, requires_arch<sve>
) noexcept
{
...
svcmple(detail::sve_ptrue<T>(), lhs, rhs
...
svcmpgt(detail::sve_ptrue<T>(), lhs, rhs
...
// ge
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch_bool <T, A> ge(batch < T, A >
const& lhs,
batch <T, A> const &rhs, requires_arch<sve>
) noexcept
{
...
svcmpge(detail::sve_ptrue<T>(), lhs, rhs
...
inline batch <T, A> rotate_right(batch < T, A >
const& a, requires_arch <sve>) noexcept
{
return
svext(a, a, N
);
...
inline batch <T, A> swizzle(batch < T, A >
const& arg,
batch <I, A> indices, requires_arch<sve>
) noexcept
{
return
svtbl(arg, indices
...
template<class A, class T, class I>
inline batch <std::complex<T>, A> swizzle(batch < std::complex<T>, A >
const& self,
batch <I, A> indices,
        requires_arch<sve>
) noexcept
...
inline batch <T, A> swizzle(batch < T, A >
const& arg, batch_constant<batch < I, A>, idx...> indices, requires_arch <sve>) noexcept
{
static_assert(batch < T, A > ::size == sizeof...(idx), "invalid swizzle indices");
return
swizzle(arg, (batch<I, A>)
indices, sve {
});
}
...
namespace detail {
    ...
    inline batch <T, A> sve_extract_pair(batch < T, A >
    const&, batch <T, A> const& /*rhs*/, std::size_t, ::collie::simd::detail::index_sequence<>) noexcept {
...
inline batch <T, A> sve_extract_pair(batch < T, A >
const& lhs,
batch <T, A> const &rhs, std::size_t
n, ::collie::simd::detail::index_sequence<I, Is...>) noexcept
{
if (n == I)
{
return
...
{
return
sve_extract_pair(lhs, rhs, n, ::collie::simd::detail::index_sequence<Is...>()
);
}
}

template<class A, class T, size_t... Is>
inline batch <T, A> sve_extract_pair_impl(batch < T, A >
const& lhs,
batch <T, A> const &rhs, std::size_t
n, ::collie::simd::detail::index_sequence<0, Is...>) noexcept
{
if (n == 0)
{
return
...
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch <T, A> extract_pair(batch < T, A >
const& lhs,
batch <T, A> const &rhs, std::size_t
n, requires_arch <sve>) noexcept
{
constexpr std::size_t size = batch < T, A
>::size;
assert(n<size &&
"index in bounds");
return
detail::sve_extract_pair_impl(lhs, rhs, n, ::collie::simd::detail::make_index_sequence<size>()
);
}
...
const& cond,
batch <T, A> const &a, batch<T, A>
const& b, requires_arch <sve>) noexcept
{
return
svsel(cond, a, b
);
...
const& false_br, requires_arch <sve>) noexcept
{
return
select(batch_bool<T, A> {b...}, true_br, false_br, sve{}
);
}
...
// rsqrt
template<class A, class T, detail::sve_enable_floating_point_t<T> = 0>
inline batch <T, A> rsqrt(batch < T, A >
const& arg, requires_arch <sve>) noexcept
{
return
svrsqrte(arg);
...
// sqrt
template<class A, class T, detail::sve_enable_floating_point_t<T> = 0>
inline batch <T, A> sqrt(batch < T, A >
const& arg, requires_arch <sve>) noexcept
{
return

svsqrt_x(detail::sve_ptrue<T>(), arg
...
namespace detail {
    ...
    inline batch<float, A> fast_cast(batch < T, A >
    const& arg, batch<float, A> const&, requires_arch <sve>) noexcept {
    return

    svcvt_f32_x(detail::sve_ptrue<T>(), arg

    );
}

template<class A, class T, detail::enable_sized_integral_t<T, 8> = 0>
inline batch<double, A> fast_cast(batch < T, A >
const& arg, batch<double, A> const&, requires_arch <sve>) noexcept
{
return

svcvt_f64_x(detail::sve_ptrue<T>(), arg
...
const& arg, batch <int32_t, A> const&, requires_arch <sve>) noexcept
{
return

svcvt_s32_x(detail::sve_ptrue<float>(), arg

);
}

template<class A>
inline batch <uint32_t, A> fast_cast(batch < float, A >
const& arg, batch <uint32_t, A> const&, requires_arch <sve>) noexcept
{
return

svcvt_u32_x(detail::sve_ptrue<float>(), arg
...
const& arg, batch <int64_t, A> const&, requires_arch <sve>) noexcept
{
return

svcvt_s64_x(detail::sve_ptrue<double>(), arg

);
}

template<class A>
inline batch <uint64_t, A> fast_cast(batch < double, A >
const& arg, batch <uint64_t, A> const&, requires_arch <sve>) noexcept
{
return

svcvt_u64_x(detail::sve_ptrue<double>(), arg
...
const&, requires_arch <sve>,
Args... args
) noexcept
{
return detail::sve_vector_type<T> {
args... };
}

template<class A, class T, class... Args>
inline batch <std::complex<T>, A> set(batch < std::complex<T>, A >
const&, requires_arch <sve>,
Args... args_complex
) noexcept
{
return
batch <std::complex<T>>(detail::sve_vector_type<T> {args_complex.real()...},
...
svcmpne(detail::sve_ptrue<T>(), values, zero
...
namespace detail {
    ...
    inline svuint8_t sve_iota_impl(index < 1 > )
    noexcept {
    return svindex_u8(0, 1);
}
inline svuint16_t sve_iota_impl(index < 2 > )
noexcept {
return svindex_u16(0, 1); }
inline svuint32_t sve_iota_impl(index < 4 > )
noexcept {
return svindex_u32(0, 1); }
inline svuint64_t sve_iota_impl(index < 8 > )
noexcept {
return svindex_u64(0, 1); }
...
const& arg,
T val, index<I>, requires_arch<sve>
) noexcept
{
...
return
svsel(index_predicate, broadcast<A, T>(val, sve{}), arg
);
}
...
inline batch <R, A> bitwise_cast(batch < T, A >
const& arg, batch <R, A> const&, requires_arch <sve>) noexcept
{
return
svreinterpret_u8(arg);
}
...
{
return
svreinterpret_s64(arg);
}

template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch<float, A> bitwise_cast(batch < T, A >
const& arg, batch<float, A> const&, requires_arch <sve>) noexcept
{
return
svreinterpret_f32(arg);
}

template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch<double, A> bitwise_cast(batch < T, A >
const& arg, batch<double, A> const&, requires_arch <sve>) noexcept
{
return
svreinterpret_f64(arg);
}
...
const& arg, batch_bool <T_out, A> const&, requires_arch <sve>) noexcept
{
return arg.
data;
}
...
// from_bool
template<class A, class T, detail::sve_enable_all_t<T> = 0>
inline batch <T, A> from_bool(batch_bool < T, A >
const& arg, requires_arch <sve>) noexcept
{
return
select(arg, batch<T, A>(1), batch<T, A>(0)
);
}
...
namespace detail {
    ...
    template<class A, class T>
    inline batch <T, A> operator()(batch < T, A >
    const&) noexcept {
    return batch <T, A> {
};
}
...
// isnan
template<class A, class T, detail::sve_enable_floating_point_t<T> = 0>
inline batch_bool <T, A> isnan(batch < T, A >
const& arg, requires_arch <sve>) noexcept
{
return !(arg == arg);
}
...
// nearbyint
template<class A, class T, detail::sve_enable_floating_point_t<T> = 0>
inline batch <T, A> nearbyint(batch < T, A >
const& arg, requires_arch <sve>) noexcept
{
return

svrintx_x(detail::sve_ptrue<T>(), arg
...
// nearbyint_as_int
template<class A>
inline batch <int32_t, A> nearbyint_as_int(batch < float, A >
const& arg, requires_arch <sve>) noexcept
{
const auto nearest = svrintx_x(detail::sve_ptrue < float > (), arg);
return

svcvt_s32_x(detail::sve_ptrue<float>(), nearest
...
svcvt_s64_x(detail::sve_ptrue<double>(), nearest
