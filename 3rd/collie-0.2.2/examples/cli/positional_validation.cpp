...
int main(int argc, char **argv) {
    ...
    collie::App app("test for positional validation");

    int num1{-1}, num2{-1};
    app.add_option("num1", num1, "first number")->check(collie::Number);
    app.add_option("num2", num2, "second number")->check(collie::Number);
