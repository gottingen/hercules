...
// 3-way quick sort
    ...
    void parallel_3wqsort(collie::tf::Runtime &rt, RandItr first, RandItr last, C compare) {
        ...
        if (l - first > 1 && is_swapped_l) {
            //rt.emplace([&](collie::tf::Runtime& rtl) mutable {
        ...
        if (last - r > 1 && is_swapped_r) {
            //rt.emplace([&](collie::tf::Runtime& rtr) mutable {
