...
#ifndef COLLIE_SIMD_ARCH_SSE4_1_H_
#define COLLIE_SIMD_ARCH_SSE4_1_H_
...
namespace collie::simd {
    ...
    namespace kernel {
        ...
        namespace detail {
            ...
            fast_cast(batch<int64_t, A> const &x, batch<double, A> const &, requires_arch<sse4_1>) noexcept {
            ...
            template<class A>
            inline batch<double, A>
            fast_cast(batch<uint64_t, A> const &x, batch<double, A> const &, requires_arch<sse4_1>) noexcept {
                // from https://stackoverflow.com/questions/41144668/how-to-efficiently-perform-double-int64-conversions-with-sse-avx
        ...
        select(batch_bool_constant<batch<float, A>, Values...> const &, batch<float, A> const &true_br,
               batch<float, A> const &false_br, requires_arch<sse4_1>) noexcept {
...
#endif  // COLLIE_SIMD_ARCH_SSE4_1_H_
