...
#ifndef COLLIE_BASE_ENDIAN_H_
#define COLLIE_BASE_ENDIAN_H_

#include <collie/base/swap_byte_order.h>
...
namespace collie {
    ...
    namespace detail {
        ...
        struct PickAlignment {
            enum {
                value = alignment == 0 ? alignof(T) : alignment
            };
        };
    ...
    namespace endian {
        ...
        template<typename T>
        inline T read(const void *P, endianness E) {
        ...
        template<typename T>
        inline void write(void *P, T V, endianness E) {
