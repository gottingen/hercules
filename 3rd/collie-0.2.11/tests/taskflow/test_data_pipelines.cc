...
// --------------------------------------------------------
void data_pipeline_1P(size_t L, unsigned w, collie::tf::PipeType type) {
  ...
  for (size_t N = 0; N <= maxN; N++) {
    ...
    // serial direction
    if (type == collie::tf::PipeType::SERIAL) {
      collie::tf::Taskflow taskflow;
      size_t j = 0;
      collie::tf::DataPipeline pl (L, collie::tf::make_data_pipe<collie::tf::Pipeflow&, void>(type, [L, N, &j, &source](auto& pf) mutable {
        if (j == N) {
          pf.stop();
          return;
        }
...
void data_pipeline_2P_SS(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    collie::tf::DataPipeline pl(
      L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j1, L](auto& pf) mutable {
        if(j1 == N) {
          pf.stop();
          return 0;
        }
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [N, &source, &j2, L](int& input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2 < N);
        REQUIRE(pf.token() % L == pf.line());
...
void data_pipeline_2P_SP(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    collie::tf::DataPipeline pl(L,
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::PARALLEL,
      [N, &collection, &mutex, &j2, L](int& input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2++ < N);
        {
...
void data_pipeline_3P_SSS(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    collie::tf::DataPipeline pl(L,
      ...
      collie::tf::make_data_pipe<int, std::string>(collie::tf::PipeType::SERIAL, [N, &source, &j2, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2 < N);
        REQUIRE(source[j2] + 1 == input);
        REQUIRE(pf.token() % L == pf.line());
      ...
      collie::tf::make_data_pipe<std::string, void>(collie::tf::PipeType::SERIAL, [N, &source, &j3, L](std::string input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j3 < N);
...
void data_pipeline_3P_SSP(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    collie::tf::DataPipeline pl(L,
      ...
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::SERIAL, [N, &source, &j2, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2 < N);
        REQUIRE(source[j2] + 1 == input);
        REQUIRE(pf.token() % L == pf.line());
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::PARALLEL, [N, &j3, &mutex, &collection, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j3++ < N);
        {
          std::scoped_lock<std::mutex> lock(mutex);
          REQUIRE(pf.token() % L == pf.line());
...
void data_pipeline_3P_SPS(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    collie::tf::DataPipeline pl(L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j1, L](collie::tf::Pipeflow& pf) mutable {
        if(j1 == N) {
          pf.stop();
          return 0;
        }
      ...
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::PARALLEL, [N, &j2, &mutex, &collection, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2++ < N);
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [N, &source, &j3, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j3 < N);
        REQUIRE(pf.token() % L == pf.line());
...
void data_pipeline_3P_SPP(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    collie::tf::DataPipeline pl(L,
      ...
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::PARALLEL, [N, &j2, &mutex2, &collection2, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2++ < N);
        //*pf.output() = *pf.input() + 1;
        {
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::PARALLEL, [N, &j3, &mutex3, &collection3, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j3++ < N);
        {
...
void three_parallel_data_pipelines(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    // pipeline 1 is SSSS
    collie::tf::DataPipeline pl1(L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j1_1, L](collie::tf::Pipeflow& pf) mutable {
        if(j1_1 == N) {
          pf.stop();
          return 0;
        }
      ...
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::SERIAL, [N, &source, &j1_2, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j1_2 < N);
        REQUIRE(pf.token() % L == pf.line());
      ...
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::SERIAL, [N, &source, &j1_3, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j1_3 < N);
        REQUIRE(pf.token() % L == pf.line());
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [N, &source, &j1_4, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j1_4 < N);
        REQUIRE(pf.token() % L == pf.line());
    ...
    // pipeline 2 is SSP
    collie::tf::DataPipeline pl2(L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j2_1, L](collie::tf::Pipeflow& pf) mutable {
        if(j2_1 == N) {
          pf.stop();
          return 0 ;
        }
      ...
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::SERIAL, [N, &source, &j2_2, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2_2 < N);
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::PARALLEL, [N, &j2_3, &mutex2_3, &collection2_3, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j2_3++ < N);
        {
    ...
    // pipeline 3 is SP
    collie::tf::DataPipeline pl3(L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j3_1, L](collie::tf::Pipeflow& pf) mutable {
        if(j3_1 == N) {
          pf.stop();
          return 0;
        }
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::PARALLEL,
      [N, &collection3_2, &mutex3_2, &j3_2, L](int input, collie::tf::Pipeflow& pf) mutable {
        REQUIRE(j3_2++ < N);
        {
...
void three_concatenated_data_pipelines(size_t L, unsigned w) {
  ...
  for(size_t N = 0; N <= maxN; N++) {
    ...
    // pipeline 1 is SSSS
    collie::tf::DataPipeline pl1(L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j1_1, L](auto& pf) mutable {
        if(j1_1 == N) {
          pf.stop();
          return 0;
        }
      ...
      collie::tf::make_data_pipe<int, std::string>(collie::tf::PipeType::SERIAL, [N, &source, &j1_2, L](int input, auto& pf) mutable {
        REQUIRE(j1_2 < N);
        REQUIRE(pf.token() % L == pf.line());
        REQUIRE(source[j1_2] + 1 == input);
        // mybuffer1[pf.line()][pf.pipe()] = source[j1_2] + 1;
      ...
      collie::tf::make_data_pipe<std::string, int>(collie::tf::PipeType::SERIAL, [N, &source, &j1_3, L](std::string& input, auto& pf) mutable {
        REQUIRE(j1_3 < N);
        REQUIRE(pf.token() % L == pf.line());
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [N, &source, &j1_4, L](int input, auto& pf) mutable {
        REQUIRE(j1_4 < N);
        REQUIRE(pf.token() % L == pf.line());
        REQUIRE(source[j1_4] + 1 == input);
        j1_4++;
    ...
    // pipeline 2 is SSP
    collie::tf::DataPipeline pl2(L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j2_1, L](auto& pf) mutable {
        if(j2_1 == N) {
          pf.stop();
          return 0;
        }
      ...
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::SERIAL, [N, &source, &j2_2, L](int input, auto& pf) mutable {
        REQUIRE(j2_2 < N);
        REQUIRE(source[j2_2] + 1 == input);
        REQUIRE(pf.token() % L == pf.line());
        // mybuffer2[pf.line()][pf.pipe()] = source[j2_2] + 1;
      ...
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::PARALLEL, [N, &j2_3, &mutex2_3, &collection2_3, L](int input, auto& pf) mutable {
        REQUIRE(j2_3++ < N);
        {
          std::scoped_lock<std::mutex> lock(mutex2_3);
          REQUIRE(pf.token() % L == pf.line());
    ...
    // pipeline 3 is SP
    collie::tf::DataPipeline pl3(L,
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [N, &source, &j3_1, L](auto& pf) mutable {
        if(j3_1 == N) {
          pf.stop();
          return 0;
        }
...
void looping_data_pipelines(size_t L, unsigned w) {
  ...
  collie::tf::DataPipeline pl(L,
    ...
    collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::PARALLEL, [&N, &j2, &mutex2, &collection2, L](int input, auto& pf) mutable {
      REQUIRE(j2++ < N);
      {
        std::scoped_lock<std::mutex> lock(mutex2);
        REQUIRE(pf.token() % L == pf.line());
    ...
    collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::SERIAL, [&N, &source, &j3, L](int input, auto& pf) mutable {
      REQUIRE(j3 < N);
      REQUIRE(pf.token() % L == pf.line());
      REQUIRE(source[j3] + 2 == input);
      // mybuffer[pf.line()][pf.pipe()] = mybuffer[pf.line()][pf.pipe() - 1] + 1;
    ...
    collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::PARALLEL, [&N, &j4, &mutex4, &collection4, L](int input, auto& pf) mutable {
      REQUIRE(j4++ < N);
      {
...
void ifelse_data_pipeline(size_t L, unsigned w) {
  ...
  for(size_t N = 1; N < maxN; ++N) {
    ...
    collie::tf::DataPipeline pl(L,
      // pipe 1
      collie::tf::make_data_pipe<collie::tf::Pipeflow&, int>(collie::tf::PipeType::SERIAL, [&, N](auto& pf){
        if(pf.token() == N) {
          pf.stop();
          return 0;
        }
      ...
      // pipe 2
      collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::PARALLEL, [&](int input){
      ...
      // pipe 3
      collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [&](int input){
        int tmp = 0;
        if((input + 9) / 4 < 50) {
  ...
  for (size_t N = 1; N < maxN; ++N) {
    for(size_t subN = 1; subN < maxsubN; ++subN) {
      ...
      collie::tf::DataPipeline pl(L,
        ...
        // begin of pipe 1 -----------------------------
        collie::tf::make_data_pipe<void, int>(collie::tf::PipeType::SERIAL, [&, N, subN, subL](auto& pf) mutable {
          if(j1 == N) {
            pf.stop();
            return 0;
          }
          ...
          // subpipeline
          collie::tf::DataPipeline subpl(subL,

            // subpipe 1
            collie::tf::make_data_pipe<void, int>(collie::tf::PipeType::SERIAL, [&, subN](auto& subpf) mutable {
              if(subj1 == subN) {
                subpf.stop();
                return 0;
              }
            ...
            // subpipe 2
            collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::PARALLEL, [&, subN](int input, auto& subpf) mutable {
              REQUIRE(subj2++ < subN);
              REQUIRE(subpf.token() % subL == subpf.line());
            ...
            // subpipe 3
            collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [&, subN](int input, auto& subpf) mutable {
              REQUIRE(subj3 < subN);
              REQUIRE(subpf.token() % subL == subpf.line());
        ...
        // end of pipe 1 -----------------------------
         ...
         //begin of pipe 2 ---------------------------
        collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::PARALLEL, [&, N, subN, subL](int input, auto& pf) mutable {
          REQUIRE(j2++ < N);
          ...
          collie::tf::DataPipeline subpl(subL,
            ...
            // subpipe 2
            collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::PARALLEL, [&, subN](int in, auto& subpf) mutable {
              REQUIRE(subj2++ < subN);
              REQUIRE(subpf.token() % subL == subpf.line());
            ...
            // subpipe 3
            collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [&, subN](int in, auto& subpf) mutable {
              REQUIRE(subj3 < subN);
              REQUIRE(subpf.token() % subL == subpf.line());
        ...
        // begin of pipe 3 ---------------------------
        collie::tf::make_data_pipe<int, int>(collie::tf::PipeType::SERIAL, [&, N, subN, subL](int input, auto& pf) mutable {
        ...
        // begin of pipe 4 ---------------------------
        collie::tf::make_data_pipe<int, void>(collie::tf::PipeType::SERIAL, [&, subN](int input) mutable {
