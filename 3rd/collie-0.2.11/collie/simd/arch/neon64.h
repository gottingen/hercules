...
#ifndef COLLIE_SIMD_ARCH_NEON64_H_
#define COLLIE_SIMD_ARCH_NEON64_H_
...
#define collie_simd_aligned_load(inst, type, expr) inst((type)expr)
        ...
        {
            return collie_simd_aligned_load(vld1q_f64, double*, src);
        }
...
#undef WRAP_REDUCER_FLOAT
        ...
        namespace detail
        {
            ...
            inline batch<double, A> extract_pair(batch<double, A> const& lhs, batch<double, A> const& rhs, std::size_t n,
                                                 ::collie::simd::detail::index_sequence<I, Is...>) noexcept
            {
                if (n == I)
                {
        ...
        inline batch<double, A> extract_pair(batch<double, A> const& lhs, batch<double, A> const& rhs, std::size_t n, requires_arch<neon64>) noexcept
        {
            ...
            return detail::extract_pair(lhs, rhs, n, ::collie::simd::detail::make_index_sequence<size>());
        }
...
#undef WRAP_CAST
    ...
    namespace kernel
    {
        ...
        namespace detail
        {
            using ::collie::simd::batch_constant;
            using ::collie::simd::detail::integer_sequence;
            using ::collie::simd::detail::make_integer_sequence;
...
#endif  // COLLIE_SIMD_ARCH_NEON64_H_
