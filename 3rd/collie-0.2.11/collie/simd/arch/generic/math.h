...
#ifndef COLLIE_SIMD_ARCH_GENERIC_MATH_H_
#define COLLIE_SIMD_ARCH_GENERIC_MATH_H_

#include <collie/simd/arch/scalar.h>
#include <collie/simd/arch/generic/details.h>
#include <collie/simd/arch/generic/trigo.h>
...
namespace collie::simd {
    ...
    namespace kernel {
        ...
        namespace detail {
            ...
            inline batch<T_out, A>
            batch_cast(batch<T_in, A> const &self, batch<T_out, A> const &out, requires_arch <generic>,
            ...
            template<class A, class T_out, class T_in>
            inline batch<T_out, A>
            batch_cast(batch<T_in, A> const &self, batch<T_out, A> const &, requires_arch <generic>,
        ...
        template<class A, class T_out, class T_in>
        inline batch<T_out, A>
        batch_cast(batch<T_in, A> const &self, batch<T_out, A> const &out, requires_arch <generic>) noexcept {
        ...
        template<class A, class T>
        inline batch<T, A>
        bitwise_cast(batch<T, A> const &self, batch<T, A> const &, requires_arch <generic>) noexcept {
            return self;
        }
        ...
        inline batch<float, A> cbrt(batch<float, A> const &self, requires_arch <generic>) noexcept {
...
#ifndef COLLIE_SIMD_NO_DENORMALS
            ...
            x = x | bitofsign(self);
#endif
#ifndef COLLIE_SIMD_NO_INFINITIES
        ...
        template<class A, class T>
        inline batch<T, A>
        clip(batch<T, A> const &self, batch<T, A> const &lo, batch<T, A> const &hi, requires_arch <generic>) noexcept {
        ...
        inline batch<T, A>
        copysign(batch<T, A> const &self, batch<T, A> const &other, requires_arch <generic>) noexcept {
...
#ifndef COLLIE_SIMD_NO_INFINITIES
            r1 = select(collie::simd::isinf(self), sign(self), r1);
#endif
            return r1;
        }
...
#ifndef COLLIE_SIMD_NO_INFINITIES
            z = select(collie::simd::isinf(self), sign(self), z);
#endif
        ...
        namespace detail {
            ...
            private:
                ...
                inline B eval(::collie::simd::detail::index_sequence<Is...>, const Tuple &tuple) {
                    return estrin{x * x}(std::get<Is>(tuple)...);
                }

                template<class... Args>
                inline B eval(const std::tuple<Args...> &tuple) noexcept {
                    return eval(::collie::simd::detail::make_index_sequence<sizeof...(Args)>(), tuple);
                }
                ...
                inline B
                eval(const std::tuple<Args...> &tuple, const B &c0, const B &c1, const Ts &... coefs) noexcept {
        ...
        namespace detail {
            ...
            struct exp_reduction<double, A, exp_tag> : exp_reduction_base<batch<double, A>, exp_tag> {
                ...
                static inline batch_type
                reduce(const batch_type &a, batch_type &hi, batch_type &lo, batch_type &x) noexcept {
                    batch_type k = nearbyint(constants::invlog_2<batch_type>() * a);
                ...
                static inline batch_type finalize(const batch_type &x, const batch_type &c, const batch_type &hi,
                                                  const batch_type &lo) noexcept {
            ...
            struct exp_reduction<double, A, exp10_tag> : exp_reduction_base<batch<double, A>, exp10_tag> {
                ...
                static inline batch_type approx(const batch_type &x) noexcept {
                    batch_type xx = x * x;
                    batch_type px = x *
                                    detail::horner<batch_type, 0x40a2b4798e134a01ull, 0x40796b7a050349e4ull, 0x40277d9474c55934ull, 0x3fa4fd75f3062dd4ull>(
                                            xx);
                    batch_type x2 = px /
                                    (detail::horner1<batch_type, 0x40a03f37650df6e2ull, 0x4093e05eefd67782ull, 0x405545fdce51ca08ull>(
                                            xx) - px);
                    return ++(x2 + x2);
                }

                static inline batch_type
                reduce(const batch_type &a, batch_type &, batch_type &, batch_type &x) noexcept {
                    batch_type k = nearbyint(constants::invlog10_2<batch_type>() * a);
                    x = fnma(k, constants::log10_2hi<batch_type>(), a);
                ...
                static inline batch_type
                finalize(const batch_type &, const batch_type &c, const batch_type &, const batch_type &) noexcept {
                    return c;
                }
            };
            ...
            struct exp_reduction<double, A, exp2_tag> : exp_reduction_base<batch<double, A>, exp2_tag> {
                ...
                static inline batch_type
                finalize(const batch_type &x, const batch_type &c, const batch_type &, const batch_type &) noexcept {
        ...
        namespace detail {
            ...
            static inline batch<float, A> expm1(const batch<float, A> &a) noexcept {
                ...
                using i_type = as_integer_t<batch_type>;
                i_type ik = to_int(k);
                batch_type two2mk = ::collie::simd::bitwise_cast<float>(
                        (constants::maxexponent<batch_type>() - ik) << constants::nmb<batch_type>());
            ...
            static inline batch<double, A> expm1(const batch<double, A> &a) noexcept {
                ...
                using i_type = as_integer_t<batch_type>;
                i_type ik = to_int(k);
                batch_type two2mk = ::collie::simd::bitwise_cast<double>(
                        (constants::maxexponent<batch_type>() - ik) << constants::nmb<batch_type>());
        ...
        polar(const batch<T, A> &r, const batch<T, A> &theta, requires_arch <generic>) noexcept {
        ...
        template<class A, class T>
        inline batch<T, A>
        frexp(const batch<T, A> &self, batch<as_integer_t<T>, A> &exp, requires_arch <generic>) noexcept {
            using batch_type = batch<T, A>;
            using int_type = as_integer_t<T>;
            using i_type = batch<int_type, A>;
            i_type m1f = constants::mask1frexp<batch_type>();
            i_type r1 = m1f & ::collie::simd::bitwise_cast<int_type>(self);
            batch_type x = self & ::collie::simd::bitwise_cast<T>(~m1f);
            ...
            return select((self != batch_type(0.)), x | ::collie::simd::bitwise_cast<T>(constants::mask2frexp<batch_type>()),
                          batch_type(0.));
        }
        ...
        inline batch<T, A> ipow(batch<T, A> const &self, ITy other, requires_arch <generic>) noexcept {
            return ::collie::simd::detail::ipow(self, other);
        }
        ...
        template<class A, class T>
        inline batch<T, A>
        ldexp(const batch<T, A> &self, const batch<as_integer_t<T>, A> &other, requires_arch <generic>) noexcept {
            using batch_type = batch<T, A>;
            using itype = as_integer_t<batch_type>;
            itype ik = other + constants::maxexponent<T>();
            ik = ik << constants::nmb<T>();
            return self * ::collie::simd::bitwise_cast<T>(ik);
        }
...
#endif
            i_type ix = ::collie::simd::bitwise_cast<int_type>(x);
            ix += 0x3f800000 - 0x3f3504f3;
            k += (ix >> 23) - 0x7f;
            ix = (ix & i_type(0x007fffff)) + 0x3f3504f3;
            x = ::collie::simd::bitwise_cast<float>(ix);
            batch_type f = --x;
...
#ifndef COLLIE_SIMD_NO_INFINITIES
            batch_type zz = select(isnez,
                                   select(self == constants::infinity<batch_type>(), constants::infinity<batch_type>(),
                                          r), constants::minusinfinity<batch_type>());
#else
        ...
        inline batch<double, A> log(batch<double, A> const &self, requires_arch <generic>) noexcept {
            ...
            batch_type x = self;
            i_type hx = ::collie::simd::bitwise_cast<int_type>(x) >> 32;
            i_type k(0);
            auto isnez = (self != batch_type(0.));
#ifndef COLLIE_SIMD_NO_DENORMALS
            auto test = (self < constants::smallestposval<batch_type>()) && isnez;
            ...
            x = ::collie::simd::bitwise_cast<double>(hx << 32 | (i_type(0xffffffff) & ::collie::simd::bitwise_cast<int_type>(x)));
            ...
            batch_type t1 =
                    w * detail::horner<batch_type, 0x3fd999999997fa04ll, 0x3fcc71c51d8e78afll, 0x3fc39a09d078c69fll>(w);
            batch_type t2 = z *
                            detail::horner<batch_type, 0x3fe5555555555593ll, 0x3fd2492494229359ll, 0x3fc7466496cb03dell, 0x3fc2f112df3e5244ll>(
                                    w);
            batch_type R = t2 + t1;
            batch_type r = fma(dk, constants::log_2hi<batch_type>(),
                               fma(s, (hfsq + R), dk * constants::log_2lo<batch_type>()) - hfsq + f);
        ...
        inline batch<double, A> log2(batch<double, A> const &self, requires_arch <generic>) noexcept {
            ...
            hi = hi & ::collie::simd::bitwise_cast<double>((constants::allbits<i_type>() << 32));
            batch_type lo = fma(s, hfsq + R, f - hi - hfsq);
            batch_type val_hi = hi * constants::invlog_2hi<batch_type>();
            batch_type val_lo = fma(lo + hi, constants::invlog_2lo<batch_type>(),
                                    lo * constants::invlog_2hi<batch_type>());
            batch_type dk = to_float(k);
        ...
        inline batch<float, A> log10(batch<float, A> const &self, requires_arch <generic>) noexcept {
            ...
            hibits &= ::collie::simd::bitwise_cast<float>(i_type(0xfffff000));
        ...
        inline batch<float, A> log1p(batch<float, A> const &self, requires_arch <generic>) noexcept {
            ...
            i_type iu = ::collie::simd::bitwise_cast<int_type>(uf);
            iu += 0x3f800000 - 0x3f3504f3;
            i_type k = (iu >> 23) - 0x7f;
            iu = (iu & i_type(0x007fffff)) + 0x3f3504f3;
            batch_type f = --(::collie::simd::bitwise_cast<float>(iu));
            batch_type s = f / (batch_type(2.) + f);
            batch_type z = s * s;
            batch_type w = z * z;
            batch_type t1 = w * detail::horner<batch_type, 0x3eccce13, 0x3e789e26>(w);
        ...
        inline batch<double, A> log1p(batch<double, A> const &self, requires_arch <generic>) noexcept {
            ...
            const batch_type uf = self + batch_type(1.);
            auto isnez = (uf != batch_type(0.));
            i_type hu = ::collie::simd::bitwise_cast<int_type>(uf) >> 32;
            ...
            batch_type f = ::collie::simd::bitwise_cast<double>(
                    (hu << 32) | (i_type(0xffffffff) & ::collie::simd::bitwise_cast<int_type>(uf)));
            f = --f;
            batch_type hfsq = batch_type(0.5) * f * f;
            batch_type s = f / (batch_type(2.) + f);
            batch_type z = s * s;
        ...
        template<class A, class T>
        inline batch<std::complex<T>, A>
        log1p(batch<std::complex<T>, A> const &self, requires_arch <generic>) noexcept {
            using batch_type = batch<std::complex<T>, A>;
            using real_batch = typename batch_type::real_batch;
            batch_type u = 1 + self;
        ...
        nearbyint_as_int(batch<float, A> const &self, requires_arch <generic>) noexcept {
            ...
            return kernel::detail::apply_transform<U>([](float x) noexcept -> U { return std::nearbyintf(x); },
                                                      self);
        }
        ...
        nearbyint_as_int(batch<double, A> const &self, requires_arch <generic>) noexcept {
            ...
            return kernel::detail::apply_transform<U>([](double x) noexcept -> U { return std::nearbyint(x); },
                                                      self);
        }
        ...
        namespace detail {
            ...
            struct nextafter_kernel<T, A, false> {
                ...
                static inline batch_type next(const batch_type &b) noexcept {
                    batch_type n = ::collie::simd::bitwise_cast<T>(::collie::simd::bitwise_cast<int_type>(b) + int_type(1));
                    return select(b == constants::infinity<batch_type>(), b, n);
                }

                static inline batch_type prev(const batch_type &b) noexcept {
                    batch_type p = ::collie::simd::bitwise_cast<T>(::collie::simd::bitwise_cast<int_type>(b) - int_type(1));
        ...
        template<class A, class T>
        inline batch<std::complex<T>, A>
        pow(const batch<std::complex<T>, A> &a, const batch<std::complex<T>, A> &z, requires_arch <generic>) noexcept {
        ...
        namespace detail {
            ...
            inline T reduce(Op op, batch<T, A> const &self, std::integral_constant<unsigned, Lvl>) noexcept {
                ...
                batch<T, A> split = swizzle(self, make_batch_constant<batch<index_type, A>, split_high<index_type,
                        Lvl / 2>>());
        ...
        remainder(batch<float, A> const &self, batch<float, A> const &other, requires_arch <generic>) noexcept {
            return fnma(nearbyint(self / other), other, self);
        }

        template<class A>
        inline batch<double, A>
        remainder(batch<double, A> const &self, batch<double, A> const &other, requires_arch <generic>) noexcept {
            return fnma(nearbyint(self / other), other, self);
        }

        template<class A, class T, class = typename std::enable_if<std::is_integral<T>::value, void>::type>
        inline batch<T, A>
        remainder(batch<T, A> const &self, batch<T, A> const &other, requires_arch <generic>) noexcept {
            auto mod = self % other;
        ...
        // select
        template<class A, class T>
        inline batch<std::complex<T>, A> select(batch_bool<T, A> const &cond, batch<std::complex<T>, A> const &true_br,
                                                batch<std::complex<T>, A> const &false_br,
                                                requires_arch <generic>) noexcept {
        ...
        inline batch<std::complex<T>, A> sqrt(batch<std::complex<T>, A> const &z, requires_arch <generic>) noexcept {
            ...
            real_batch t0 = select(condxp, collie::simd::sqrt(0.5 * (r + x)), collie::simd::sqrt(0.5 * (r - x)));
...
#ifndef COLLIE_SIMD_NO_INVALIDS
...
#endif  // COLLIE_SIMD_ARCH_GENERIC_MATH_H_
