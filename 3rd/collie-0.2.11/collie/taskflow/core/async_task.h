...
A collie::tf::AsyncTask is a lightweight handle that retains @em shared ownership
...
collie::tf::AsyncTask A = executor.silent_dependent_async([](){});
...
collie::tf::AsyncTask B = executor.silent_dependent_async([](){}, A);
@endcode

Currently, collie::tf::AsyncTask is implemented based on the logic of
