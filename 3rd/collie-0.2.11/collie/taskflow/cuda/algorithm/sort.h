...
#include <collie/taskflow/cuda/algorithm/merge.h>
...
}  // end of namespace collie::tf::detail ---------------------------------------------
...
@tparam K key type
@tparam V value type (default collie::tf::cudaEmpty)

@param count number of keys/values to sort

The function is used to allocate a buffer for calling collie::tf::cuda_sort.
...
This method is equivalent to collie::tf::cuda_sort_by_key without values.
