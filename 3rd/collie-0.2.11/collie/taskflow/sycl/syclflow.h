...
#include <collie/taskflow/sycl/sycl_task.h>
...
namespace collie::tf {
    ...
    */
    ...
    public:
        ...
        (e.g., collie::tf::syclFlow::offload).
        */
        ...
        */
        ...
        Similar to collie::tf::syclFlow::on but operates on an existing task.
        */
        template<typename F, std::enable_if_t<
                std::is_invocable_r_v<void, F, sycl::handler &>, void> * = nullptr
        >
        ...
        @return a collie::tf::syclTask handle
        ...
        */
        ...
        /**
        @brief similar to collie::tf::syclFlow::reduce but does not assume any initial
               value to reduce
        ...
        */
        ...
        Similar to collie::tf::syclFlow::memcpy but operates on an existing task.
        */
        ...
        Similar to collie::tf::syclFlow::memset but operates on an existing task.
        */
        ...
        Similar to collie::tf::syclFlow::fill but operates on an existing task.
        */
        template<typename T>
        ...
        Similar to collie::tf::syclFlow::copy but operates on an existing task.
        */
        template<typename T,
                std::enable_if_t<!std::is_same_v<T, void>, void> * = nullptr
        >
        ...
        Similar to collie::tf::syclFlow::parallel_for but operates on an existing task.
        */
        template<typename...ArgsT>
        ...
        Similar to collie::tf::syclFlow::single_task but operates on an existing task.
        */
        template<typename F>
