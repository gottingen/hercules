...
template <class StrongTypedef>
struct TYPE_SAFE_MSC_EMPTY_BASES hashable : std::hash<collie::ts::underlying_type<StrongTypedef>>
{
    using underlying_type = collie::ts::underlying_type<StrongTypedef>;
