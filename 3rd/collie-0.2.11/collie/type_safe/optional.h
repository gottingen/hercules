...
#include <collie/type_safe/detail/assign_or_construct.h>
#include <collie/type_safe/detail/copy_move_control.h>
#include <collie/type_safe/detail/is_nothrow_swappable.h>
#include <collie/type_safe/detail/map_invoke.h>
...
/// \module optional
template <class StoragePolicy>
struct hash<collie::ts::basic_optional<StoragePolicy>>
{
    using value_type = typename StoragePolicy::value_type;
    using value_hash = std::hash<value_type>;

    std::size_t operator()(const collie::ts::basic_optional<StoragePolicy>& opt) const
