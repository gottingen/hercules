...
#include <collie/type_safe/types.h>
...
/// \param 1
/// \exclude
template <typename Enum, typename = collie::ts::detail::enable_flag<Enum>>
constexpr collie::ts::flag_mask<Enum> operator~(const Enum& e) noexcept
{
    return collie::ts::flag_mask<Enum>::all_set().reset(e);
}
...
/// \exclude
template <typename Enum, typename = collie::ts::detail::enable_flag<Enum>>
constexpr collie::ts::flag_combo<Enum> operator|(const Enum& a, const Enum& b) noexcept
{
    return collie::ts::flag_combo<Enum>(a) | b;
}
