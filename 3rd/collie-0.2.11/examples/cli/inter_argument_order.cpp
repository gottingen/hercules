...
int main(int argc, char **argv) {
    collie::App app{"An app to practice mixing unlimited arguments, but still recover the original order."};
    ...
    // Standard parsing lines (copy and paste in, or use COLLIE_CLI_PARSE)
    try {
        app.parse(argc, argv);
