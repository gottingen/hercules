...
#include <collie/taskflow/sycl/algorithm/reduce.h>
...
int main(int argc, char* argv[]) {
  ...
  *res2 = 10;
  ...
  collie::tf::syclDefaultExecutionPolicy policy(queue);

  collie::tf::sycl_reduce(policy, data, data+N, res1, [](int a, int b){ return a+b; });

  //// perform reduction
  //collie::tf::syclFlow syclflow(queue);
  //
