...
//
//
#include <collie/type_safe/bounded_type.h>
...
TEST_CASE("clamped_type")
{
    ...
    SUBCASE("clamping_lower")
    {
        value = -42;
    }
    SUBCASE("clamping_upper")
    {
        value = 100;
    }
