...
namespace collie::simd
{
    ...
    struct test_int_min_max<batch<T>, 2>
    {
        void run()
        {
            ...
            auto r1 = collie::simd::max(a, c);
            auto r3 = collie::simd::min(a, c);
            ...
            auto r4 = a < b; // test lt
            BB e4 = { 1, 0 };
            CHECK_UNARY(collie::simd::all(r4 == e4));
        }
    };
    ...
    struct test_int_min_max<batch<T>, 16>
    {
        void run()
        {
            ...
            auto r1 = collie::simd::max(a, b);
            auto r3 = collie::simd::min(a, b);
            auto r4 = a < b; // test lt
            auto r5 = a == c;
            auto r6 = a != c;
            ...
            CHECK_UNARY(collie::simd::all(r5 == e5));
            CHECK_UNARY(collie::simd::all(r6 == !e5));
        }
    };
...
struct batch_int_test
{
    ...
    {
        collie::simd::test_int_min_max<batch_type> t;
        t.run();
    }
    ...
    void test_less_than_underflow() const
    {
        ...
        {
            CHECK_FALSE(collie::simd::any(test_negative_compare < 1));
        }
        else
        {
            CHECK_UNARY(collie::simd::all(test_negative_compare < 1));
        }
    }
