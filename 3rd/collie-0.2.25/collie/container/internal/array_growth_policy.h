...
#define COLLIE_AH_NB_PRIMES 51
#elif SIZE_MAX >= ULONG_MAX
#define COLLIE_AH_NB_PRIMES 40
#else
#define COLLIE_AH_NB_PRIMES 23
#endif

        static constexpr const std::array<std::size_t, COLLIE_AH_NB_PRIMES> PRIMES = {{
                                                                                           1u,
                                                                                           5u,
                                                                                           17u,
                                                                                           29u,
