...
TURBO_FLAG(int, usage_reporting_test_flag_01,

           101,
           "usage_reporting_test_flag_01 help message");

TURBO_FLAG(bool, usage_reporting_test_flag_02,

           false,
           "usage_reporting_test_flag_02 help message");

TURBO_FLAG(double, usage_reporting_test_flag_03,

           1.03,
           "usage_reporting_test_flag_03 help message");
TURBO_FLAG(int64_t, usage_reporting_test_flag_04,
           1000000000000004L,
...
namespace {
    ...
    static std::string NormalizeFileName(std::string_view fname) {
        ...
        auto tests_pos = fname.rfind("tests/");
        if (tests_pos != std::string_view::npos) {
            fname = fname.substr(tests_pos);
        }
...
// --------------------------------------------------------------------
  ...
  Flags from tests/flags/usage_test.cc:
...
path.
        ...
        EXPECT_TRUE(turbo::str_contains(
                test_out_str, "Flags from tests/flags/usage_test.cc:"));
        EXPECT_TRUE(
