...
// 3. Collect ProbeStats from final table.
            ...
            TEST(Table, HeterogeneousLookup) {
                ...
                raw_hash_set<IntPolicy, Hash, Eq, Alloc<int64_t>>
                        s{0, 1, 2};
                // It will convert to int64_t before the query.
                EXPECT_EQ(1, *s.find(double{1.1}));

                raw_hash_set<IntPolicy, THash, TEq, Alloc<int64_t>>
                        ts{0, 1, 2};
...
// This prevents dependency on pointer stability on small tables.
            ...
            TEST(RawHashSamplerTest, Sample) {
              ...
              size_t start_size = 0;
              turbo::flat_hash_set<const HashtablezInfo*> preexisting_info;
              ...
              size_t end_size = 0;
              turbo::flat_hash_map<size_t, int> observed_checksums;
              turbo::flat_hash_map<ssize_t, int> reservations;
