...
namespace turbo::container_internal {
    namespace {
        ...
        TEST_CASE("Layout, OffsetByIndex") {
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial().Offset<0>());
                REQUIRE_EQ(0, L::Partial(3).Offset<0>());
                REQUIRE_EQ(0, L(3).Offset<0>());
            }
            {
                using L = Layout<int32_t, int32_t>;
                REQUIRE_EQ(0, L::Partial().Offset<0>());
                REQUIRE_EQ(0, L::Partial(3).Offset<0>());
                REQUIRE_EQ(12, L::Partial(3).Offset<1>());
                REQUIRE_EQ(0, L::Partial(3, 5).Offset<0>());
                REQUIRE_EQ(12, L::Partial(3, 5).Offset<1>());
                REQUIRE_EQ(0, L(3, 5).Offset<0>());
                REQUIRE_EQ(12, L(3, 5).Offset<1>());
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(0, L::Partial().Offset<0>());
                REQUIRE_EQ(0, L::Partial(0).Offset<0>());
                REQUIRE_EQ(0, L::Partial(0).Offset<1>());
                REQUIRE_EQ(0, L::Partial(1).Offset<0>());
                REQUIRE_EQ(4, L::Partial(1).Offset<1>());
                REQUIRE_EQ(0, L::Partial(5).Offset<0>());
                REQUIRE_EQ(8, L::Partial(5).Offset<1>());
                REQUIRE_EQ(0, L::Partial(0, 0).Offset<0>());
                REQUIRE_EQ(0, L::Partial(0, 0).Offset<1>());
                REQUIRE_EQ(0, L::Partial(0, 0).Offset<2>());
                REQUIRE_EQ(0, L::Partial(1, 0).Offset<0>());
                REQUIRE_EQ(4, L::Partial(1, 0).Offset<1>());
                REQUIRE_EQ(8, L::Partial(1, 0).Offset<2>());
                REQUIRE_EQ(0, L::Partial(5, 3).Offset<0>());
                REQUIRE_EQ(8, L::Partial(5, 3).Offset<1>());
                REQUIRE_EQ(24, L::Partial(5, 3).Offset<2>());
                REQUIRE_EQ(0, L::Partial(0, 0, 0).Offset<0>());
                REQUIRE_EQ(0, L::Partial(0, 0, 0).Offset<1>());
                REQUIRE_EQ(0, L::Partial(0, 0, 0).Offset<2>());
                REQUIRE_EQ(0, L::Partial(1, 0, 0).Offset<0>());
                REQUIRE_EQ(4, L::Partial(1, 0, 0).Offset<1>());
                REQUIRE_EQ(8, L::Partial(1, 0, 0).Offset<2>());
                REQUIRE_EQ(0, L::Partial(5, 3, 1).Offset<0>());
                REQUIRE_EQ(24, L::Partial(5, 3, 1).Offset<2>());
                REQUIRE_EQ(8, L::Partial(5, 3, 1).Offset<1>());
                REQUIRE_EQ(0, L(5, 3, 1).Offset<0>());
                REQUIRE_EQ(24, L(5, 3, 1).Offset<2>());
                REQUIRE_EQ(8, L(5, 3, 1).Offset<1>());
            }
        }

        TEST_CASE("Layout, OffsetByType") {
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial().Offset<int32_t>());
                REQUIRE_EQ(0, L::Partial(3).Offset<int32_t>());
                REQUIRE_EQ(0, L(3).Offset<int32_t>());
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(0, L::Partial().Offset<int8_t>());
                REQUIRE_EQ(0, L::Partial(0).Offset<int8_t>());
                REQUIRE_EQ(0, L::Partial(0).Offset<int32_t>());
                REQUIRE_EQ(0, L::Partial(1).Offset<int8_t>());
                REQUIRE_EQ(4, L::Partial(1).Offset<int32_t>());
                REQUIRE_EQ(0, L::Partial(5).Offset<int8_t>());
                REQUIRE_EQ(8, L::Partial(5).Offset<int32_t>());
                REQUIRE_EQ(0, L::Partial(0, 0).Offset<int8_t>());
                REQUIRE_EQ(0, L::Partial(0, 0).Offset<int32_t>());
                REQUIRE_EQ(0, L::Partial(0, 0).Offset<Int128>());
                REQUIRE_EQ(0, L::Partial(1, 0).Offset<int8_t>());
                REQUIRE_EQ(4, L::Partial(1, 0).Offset<int32_t>());
                REQUIRE_EQ(8, L::Partial(1, 0).Offset<Int128>());
                REQUIRE_EQ(0, L::Partial(5, 3).Offset<int8_t>());
                REQUIRE_EQ(8, L::Partial(5, 3).Offset<int32_t>());
                REQUIRE_EQ(24, L::Partial(5, 3).Offset<Int128>());
                REQUIRE_EQ(0, L::Partial(0, 0, 0).Offset<int8_t>());
                REQUIRE_EQ(0, L::Partial(0, 0, 0).Offset<int32_t>());
                REQUIRE_EQ(0, L::Partial(0, 0, 0).Offset<Int128>());
                REQUIRE_EQ(0, L::Partial(1, 0, 0).Offset<int8_t>());
                REQUIRE_EQ(4, L::Partial(1, 0, 0).Offset<int32_t>());
                REQUIRE_EQ(8, L::Partial(1, 0, 0).Offset<Int128>());
                REQUIRE_EQ(0, L::Partial(5, 3, 1).Offset<int8_t>());
                REQUIRE_EQ(24, L::Partial(5, 3, 1).Offset<Int128>());
                REQUIRE_EQ(8, L::Partial(5, 3, 1).Offset<int32_t>());
                REQUIRE_EQ(0, L(5, 3, 1).Offset<int8_t>());
                REQUIRE_EQ(24, L(5, 3, 1).Offset<Int128>());
                REQUIRE_EQ(8, L(5, 3, 1).Offset<int32_t>());
            }
        }


        TEST_CASE("Layout, AllocSize") {
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial(0).AllocSize());
                REQUIRE_EQ(12, L::Partial(3).AllocSize());
                REQUIRE_EQ(12, L(3).AllocSize());
            }
            {
                using L = Layout<int32_t, int32_t>;
                REQUIRE_EQ(32, L::Partial(3, 5).AllocSize());
                REQUIRE_EQ(32, L(3, 5).AllocSize());
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(0, L::Partial(0, 0, 0).AllocSize());
                REQUIRE_EQ(8, L::Partial(1, 0, 0).AllocSize());
                REQUIRE_EQ(8, L::Partial(0, 1, 0).AllocSize());
                REQUIRE_EQ(16, L::Partial(0, 0, 1).AllocSize());
                REQUIRE_EQ(24, L::Partial(1, 1, 1).AllocSize());
                REQUIRE_EQ(136, L::Partial(3, 5, 7).AllocSize());
                REQUIRE_EQ(136, L(3, 5, 7).AllocSize());
            }
        }

        TEST_CASE("Layout, SizeByIndex") {
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial(0).Size<0>());
                REQUIRE_EQ(3, L::Partial(3).Size<0>());
                REQUIRE_EQ(3, L(3).Size<0>());
            }
            {
                using L = Layout<int32_t, int32_t>;
                REQUIRE_EQ(0, L::Partial(0).Size<0>());
                REQUIRE_EQ(3, L::Partial(3).Size<0>());
                REQUIRE_EQ(3, L::Partial(3, 5).Size<0>());
                REQUIRE_EQ(5, L::Partial(3, 5).Size<1>());
                REQUIRE_EQ(3, L(3, 5).Size<0>());
                REQUIRE_EQ(5, L(3, 5).Size<1>());
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(3, L::Partial(3).Size<0>());
                REQUIRE_EQ(3, L::Partial(3, 5).Size<0>());
                REQUIRE_EQ(5, L::Partial(3, 5).Size<1>());
                REQUIRE_EQ(3, L::Partial(3, 5, 7).Size<0>());
                REQUIRE_EQ(5, L::Partial(3, 5, 7).Size<1>());
                REQUIRE_EQ(7, L::Partial(3, 5, 7).Size<2>());
                REQUIRE_EQ(3, L(3, 5, 7).Size<0>());
                REQUIRE_EQ(5, L(3, 5, 7).Size<1>());
                REQUIRE_EQ(7, L(3, 5, 7).Size<2>());
            }
        }

        TEST_CASE("Layout, SizeByType") {
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial(0).Size<int32_t>());
                REQUIRE_EQ(3, L::Partial(3).Size<int32_t>());
                REQUIRE_EQ(3, L(3).Size<int32_t>());
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(3, L::Partial(3).Size<int8_t>());
                REQUIRE_EQ(3, L::Partial(3, 5).Size<int8_t>());
                REQUIRE_EQ(5, L::Partial(3, 5).Size<int32_t>());
                REQUIRE_EQ(3, L::Partial(3, 5, 7).Size<int8_t>());
                REQUIRE_EQ(5, L::Partial(3, 5, 7).Size<int32_t>());
                REQUIRE_EQ(7, L::Partial(3, 5, 7).Size<Int128>());
                REQUIRE_EQ(3, L(3, 5, 7).Size<int8_t>());
                REQUIRE_EQ(5, L(3, 5, 7).Size<int32_t>());
                REQUIRE_EQ(7, L(3, 5, 7).Size<Int128>());
            }
        }


        TEST_CASE("Layout, PointerByIndex") {
            alignas(max_align_t) const unsigned char p[100] = {};
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, Distance(p, Type<const int32_t *>(L::Partial().Pointer<0>(p))));
                REQUIRE_EQ(0,
                          Distance(p, Type<const int32_t *>(L::Partial(3).Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<const int32_t *>(L(3).Pointer<0>(p))));
            }
            {
                using L = Layout<int32_t, int32_t>;
                REQUIRE_EQ(0, Distance(p, Type<const int32_t *>(L::Partial().Pointer<0>(p))));
                ...
                REQUIRE_EQ(0, Distance(p, Type<const int32_t *>(L(3, 5).Pointer<0>(p))));
                REQUIRE_EQ(12, Distance(p, Type<const int32_t *>(L(3, 5).Pointer<1>(p))));
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(0, Distance(p, Type<const int8_t *>(L::Partial().Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<const int8_t *>(L::Partial(0).Pointer<0>(p))));
                REQUIRE_EQ(0,
                          Distance(p, Type<const int32_t *>(L::Partial(0).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<const int8_t *>(L::Partial(1).Pointer<0>(p))));
                REQUIRE_EQ(4,
                          Distance(p, Type<const int32_t *>(L::Partial(1).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<const int8_t *>(L::Partial(5).Pointer<0>(p))));
                REQUIRE_EQ(8,
                ...
                REQUIRE_EQ(0, Distance(p, Type<const int8_t *>(L(5, 3, 1).Pointer<0>(p))));
                REQUIRE_EQ(24, Distance(p, Type<const Int128 *>(L(5, 3, 1).Pointer<2>(p))));
                REQUIRE_EQ(8, Distance(p, Type<const int32_t *>(L(5, 3, 1).Pointer<1>(p))));
            }
        }

        TEST_CASE("Layout, PointerByType") {
            alignas(max_align_t) const unsigned char p[100] = {};
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(
                ...
                REQUIRE_EQ(0, Distance(p, Type<const int32_t *>(L(3).Pointer<int32_t>(p))));
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(
                ...
                REQUIRE_EQ(0, Distance(p, Type<const int32_t *>(
                ...
                REQUIRE_EQ(4, Distance(p, Type<const int32_t *>(
        ...
        TEST_CASE("Layout, MutablePointerByIndex") {
            alignas(max_align_t) unsigned char p[100];
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial().Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial(3).Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L(3).Pointer<0>(p))));
            }
            {
                using L = Layout<int32_t, int32_t>;
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial().Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial(3).Pointer<0>(p))));
                REQUIRE_EQ(12, Distance(p, Type<int32_t *>(L::Partial(3).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial(3, 5).Pointer<0>(p))));
                REQUIRE_EQ(12, Distance(p, Type<int32_t *>(L::Partial(3, 5).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L(3, 5).Pointer<0>(p))));
                REQUIRE_EQ(12, Distance(p, Type<int32_t *>(L(3, 5).Pointer<1>(p))));
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial().Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(0).Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial(0).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(1).Pointer<0>(p))));
                REQUIRE_EQ(4, Distance(p, Type<int32_t *>(L::Partial(1).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(5).Pointer<0>(p))));
                REQUIRE_EQ(8, Distance(p, Type<int32_t *>(L::Partial(5).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(0, 0).Pointer<0>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial(0, 0).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<Int128 *>(L::Partial(0, 0).Pointer<2>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(1, 0).Pointer<0>(p))));
                REQUIRE_EQ(4, Distance(p, Type<int32_t *>(L::Partial(1, 0).Pointer<1>(p))));
                REQUIRE_EQ(8, Distance(p, Type<Int128 *>(L::Partial(1, 0).Pointer<2>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(5, 3).Pointer<0>(p))));
                REQUIRE_EQ(8, Distance(p, Type<int32_t *>(L::Partial(5, 3).Pointer<1>(p))));
                REQUIRE_EQ(24, Distance(p, Type<Int128 *>(L::Partial(5, 3).Pointer<2>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(0, 0, 0).Pointer<0>(p))));
                REQUIRE_EQ(0,
                          Distance(p, Type<int32_t *>(L::Partial(0, 0, 0).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<Int128 *>(L::Partial(0, 0, 0).Pointer<2>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(1, 0, 0).Pointer<0>(p))));
                REQUIRE_EQ(4,
                          Distance(p, Type<int32_t *>(L::Partial(1, 0, 0).Pointer<1>(p))));
                REQUIRE_EQ(8, Distance(p, Type<Int128 *>(L::Partial(1, 0, 0).Pointer<2>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(5, 3, 1).Pointer<0>(p))));
                REQUIRE_EQ(24,
                          Distance(p, Type<Int128 *>(L::Partial(5, 3, 1).Pointer<2>(p))));
                REQUIRE_EQ(8,
                          Distance(p, Type<int32_t *>(L::Partial(5, 3, 1).Pointer<1>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L(5, 3, 1).Pointer<0>(p))));
                REQUIRE_EQ(24, Distance(p, Type<Int128 *>(L(5, 3, 1).Pointer<2>(p))));
                REQUIRE_EQ(8, Distance(p, Type<int32_t *>(L(5, 3, 1).Pointer<1>(p))));
            }
        }

        TEST_CASE("Layout, MutablePointerByType") {
            alignas(max_align_t) unsigned char p[100];
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L::Partial().Pointer<int32_t>(p))));
                REQUIRE_EQ(0,
                          Distance(p, Type<int32_t *>(L::Partial(3).Pointer<int32_t>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int32_t *>(L(3).Pointer<int32_t>(p))));
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial().Pointer<int8_t>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(0).Pointer<int8_t>(p))));
                REQUIRE_EQ(0,
                          Distance(p, Type<int32_t *>(L::Partial(0).Pointer<int32_t>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(1).Pointer<int8_t>(p))));
                REQUIRE_EQ(4,
                          Distance(p, Type<int32_t *>(L::Partial(1).Pointer<int32_t>(p))));
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L::Partial(5).Pointer<int8_t>(p))));
                REQUIRE_EQ(8,
                ...
                REQUIRE_EQ(0, Distance(p, Type<int8_t *>(L(5, 3, 1).Pointer<int8_t>(p))));
                REQUIRE_EQ(24, Distance(p, Type<Int128 *>(L(5, 3, 1).Pointer<Int128>(p))));
                REQUIRE_EQ(8, Distance(p, Type<int32_t *>(L(5, 3, 1).Pointer<int32_t>(p))));
            }
        }

        TEST_CASE("Layout, Pointers") {
            alignas(max_align_t) const unsigned char p[100] = {};
            using L = Layout<int8_t, int8_t, Int128>;
            {
                const auto x = L::Partial();
                REQUIRE_EQ(std::make_tuple(x.Pointer<0>(p)),
                          Type<std::tuple<const int8_t *>>(x.Pointers(p)));
            }
            {
                const auto x = L::Partial(1);
                REQUIRE_EQ(std::make_tuple(x.Pointer<0>(p), x.Pointer<1>(p)),
        ...
        TEST_CASE("Layout, MutablePointers") {
            alignas(max_align_t) unsigned char p[100];
            using L = Layout<int8_t, int8_t, Int128>;
            {
                const auto x = L::Partial();
        ...
        TEST_CASE("Layout, SliceByIndexSize") {
            alignas(max_align_t) const unsigned char p[100] = {};
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial(0).Slice<0>(p).size());
                REQUIRE_EQ(3, L::Partial(3).Slice<0>(p).size());
                REQUIRE_EQ(3, L(3).Slice<0>(p).size());
            }
            {
                using L = Layout<int32_t, int32_t>;
                REQUIRE_EQ(3, L::Partial(3).Slice<0>(p).size());
                REQUIRE_EQ(5, L::Partial(3, 5).Slice<1>(p).size());
                REQUIRE_EQ(5, L(3, 5).Slice<1>(p).size());
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(3, L::Partial(3).Slice<0>(p).size());
                REQUIRE_EQ(3, L::Partial(3, 5).Slice<0>(p).size());
                REQUIRE_EQ(5, L::Partial(3, 5).Slice<1>(p).size());
                REQUIRE_EQ(3, L::Partial(3, 5, 7).Slice<0>(p).size());
                REQUIRE_EQ(5, L::Partial(3, 5, 7).Slice<1>(p).size());
                REQUIRE_EQ(7, L::Partial(3, 5, 7).Slice<2>(p).size());
                REQUIRE_EQ(3, L(3, 5, 7).Slice<0>(p).size());
                REQUIRE_EQ(5, L(3, 5, 7).Slice<1>(p).size());
                REQUIRE_EQ(7, L(3, 5, 7).Slice<2>(p).size());
            }
        }

        TEST_CASE("Layout, SliceByTypeSize") {
            alignas(max_align_t) const unsigned char p[100] = {};
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial(0).Slice<int32_t>(p).size());
                REQUIRE_EQ(3, L::Partial(3).Slice<int32_t>(p).size());
                REQUIRE_EQ(3, L(3).Slice<int32_t>(p).size());
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(3, L::Partial(3).Slice<int8_t>(p).size());
                REQUIRE_EQ(3, L::Partial(3, 5).Slice<int8_t>(p).size());
                REQUIRE_EQ(5, L::Partial(3, 5).Slice<int32_t>(p).size());
                REQUIRE_EQ(3, L::Partial(3, 5, 7).Slice<int8_t>(p).size());
                REQUIRE_EQ(5, L::Partial(3, 5, 7).Slice<int32_t>(p).size());
                REQUIRE_EQ(7, L::Partial(3, 5, 7).Slice<Int128>(p).size());
                REQUIRE_EQ(3, L(3, 5, 7).Slice<int8_t>(p).size());
                REQUIRE_EQ(5, L(3, 5, 7).Slice<int32_t>(p).size());
                REQUIRE_EQ(7, L(3, 5, 7).Slice<Int128>(p).size());
            }
        }

        TEST_CASE("Layout, MutableSliceByIndexSize") {
            alignas(max_align_t) unsigned char p[100];
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial(0).Slice<0>(p).size());
        ...
        TEST_CASE("Layout, MutableSliceByTypeSize") {
            alignas(max_align_t) unsigned char p[100];
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(0, L::Partial(0).Slice<int32_t>(p).size());
        ...
        TEST_CASE("Layout, SliceByIndexData") {
            alignas(max_align_t) const unsigned char p[100] = {};
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(
        ...
        TEST_CASE("Layout, SliceByTypeData") {
            alignas(max_align_t) const unsigned char p[100] = {};
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(
            ...
            }
            {
                ...
                REQUIRE_EQ(
                        ...
                        Distance(p, Type<Span<const int8_t>>(L::Partial(0, 0).Slice<int8_t>(p))
                                .data()));
                REQUIRE_EQ(0, Distance(p, Type<Span<const int32_t>>(
                ...
                REQUIRE_EQ(
                        ...
                        Distance(p, Type<Span<const int8_t>>(L::Partial(1, 0).Slice<int8_t>(p))
                                .data()));
                REQUIRE_EQ(4, Distance(p, Type<Span<const int32_t>>(
                ...
                REQUIRE_EQ(
                        ...
                        Distance(p, Type<Span<const int8_t>>(L::Partial(5, 3).Slice<int8_t>(p))
                                .data()));
                REQUIRE_EQ(8, Distance(p, Type<Span<const int32_t>>(
                        L::Partial(5, 3).Slice<int32_t>(p))
                        .data()));
                REQUIRE_EQ(0, Distance(p, Type<Span<const int8_t>>(
                        L::Partial(0, 0, 0).Slice<int8_t>(p))
                        .data()));
                REQUIRE_EQ(0, Distance(p, Type<Span<const int32_t>>(
                        L::Partial(0, 0, 0).Slice<int32_t>(p))
                        .data()));
                REQUIRE_EQ(0, Distance(p, Type<Span<const Int128>>(
                ...
                REQUIRE_EQ(4, Distance(p, Type<Span<const int32_t>>(
                        ...
                        .data()));
                REQUIRE_EQ(8, Distance(p, Type<Span<const Int128>>(
                        L::Partial(1, 0, 0).Slice<Int128>(p))
                        .data()));
                REQUIRE_EQ(0, Distance(p, Type<Span<const int8_t>>(
                        L::Partial(5, 3, 1).Slice<int8_t>(p))
                        .data()));
                REQUIRE_EQ(24, Distance(p, Type<Span<const Int128>>(
        ...
        TEST_CASE("Layout, MutableSliceByIndexData") {
            alignas(max_align_t) unsigned char p[100];
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(
                ...
                REQUIRE_EQ(0, Distance(p, Type<Span<int32_t>>(L(3).Slice<0>(p)).data()));
            }
            {
                using L = Layout<int32_t, int32_t>;
                REQUIRE_EQ(
                ...
                REQUIRE_EQ(0, Distance(p, Type<Span<int32_t>>(L(3, 5).Slice<0>(p)).data()));
                REQUIRE_EQ(12, Distance(p, Type<Span<int32_t>>(L(3, 5).Slice<1>(p)).data()));
            }
            {
                using L = Layout<int8_t, int32_t, Int128>;
                REQUIRE_EQ(
        ...
        TEST_CASE("Layout, MutableSliceByTypeData") {
            alignas(max_align_t) unsigned char p[100];
            {
                using L = Layout<int32_t>;
                REQUIRE_EQ(
        ...
        TEST_CASE("Layout, ConstexprPartial") {
        ...
        void ExpectRegionPoisoned(const unsigned char *p, size_t n, bool poisoned) {
            ...
            for (size_t i = 0; i != n; ++i) {
              REQUIRE_EQ(poisoned, __asan_address_is_poisoned(p + i));
            }
#endif
        }
        ...
        TEST_CASE("Layout, PoisonPadding") {
            ...
            constexpr size_t n = L::Partial(1, 2, 3, 4).AllocSize();
            {
                ...
                x.PoisonPadding(c);
                REQUIRE_EQ(x.Slices(c), x.Slices(c));
                ExpectPoisoned(c, {});
            }
            {
        ...
        namespace example {
            ...
            TEST_CASE("CompactString, Works") {
                CompactString s = "hello";
                REQUIRE_EQ(5, s.size());
                REQUIRE_EQ("hello", std::string(s.c_str()));
            }
