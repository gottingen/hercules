...
// instrumented to throw at a controlled time.
    ...
    public:
        ...
        operator bool() const {                   // NOLINT
            exceptions_internal::MaybeThrow(TURBO_PRETTY_FUNCTION);
            return b_;
        }
    ...
    public:
        ...
        IsSpecified(TypeSpec::kNoThrowNew)) {
            if (!IsSpecified(TypeSpec::kNoThrowNew)) {
                exceptions_internal::MaybeThrow(TURBO_PRETTY_FUNCTION, true);
            }
        ...
        // Turbo doesn't support throwing overloaded operator delete.  These are
 ...
 */
    ...
    public:
        ...
        IsSpecified(AllocSpec::kNoThrowAllocate)) {
            ReadStateAndMaybeThrow(TURBO_PRETTY_FUNCTION);
