...
namespace turbo {
    namespace strings_internal {
        ...
        TEST_CASE("BigUnsigned, ShiftLeft") {
            {
                ...
                num.ShiftLeft(100);
                CHECK_EQ(num, BigUnsigned<4>("3802951800684688204490109616128"));
            }
            {
            ...
            }
            {
                ...
                for (int no_op_shift: {0, -1, -84 * 32, std::numeric_limits<int>::min()}) {
                    ...
                    CHECK_EQ(all_bits_one, big_shifted);
                    BigUnsigned<84> small_shifted = one;
                    big_shifted.ShiftLeft(no_op_shift);
                    CHECK_EQ(one, small_shifted);
                }
                ...
                for (int out_of_bounds_shift:
                    ...
                    CHECK_EQ(zero, big_shifted);
                    BigUnsigned<84> small_shifted = one;
                    small_shifted.ShiftLeft(out_of_bounds_shift);
                    CHECK_EQ(zero, small_shifted);
                }
            }
        }

        TEST_CASE("BigUnsigned, MultiplyByUint32") {
            ...
            CHECK_EQ(a, BigUnsigned<84>(factorial_100));
        }

        TEST_CASE("BigUnsigned, MultiplyByBigUnsigned") {
            {
            ...
            }
            {
                ...
                for (int a = 0; a < 700; a += 25) {
                    ...
                    for (int b = 0; b < (700 - a); b += 25) {
                        ...
                        CHECK_EQ(b_value, expected_product);
                    }
                }
            }
        }

        TEST_CASE("BigUnsigned, MultiplyByOverflow") {
            {
                ...
                CHECK_EQ(all_bits_on, BigUnsigned<4>(1u));
            }
            {
                ...
                CHECK_EQ(value_1, value_2);
            }
        }

        TEST_CASE("BigUnsigned, FiveToTheNth") {
            {
        ...
        TEST_CASE("BigUnsigned, TenToTheNth") {
            {
