...
namespace {
    ...
    struct OptionalInt : StdOptionalInt {
        using StdOptionalInt::StdOptionalInt;
    };
    ...
    struct OptionalString : StdOptionalString {
        using StdOptionalString::StdOptionalString;
    };
...
#define BM_ManyGetFlag(T)                            \
  ...
  BENCHMARK(BM_ManyGetFlag_##T)->ThreadRange(1, 8);
    ...
    BENCHMARK(BM_ThreadedFindCommandLineFlag)
    ->ThreadRange(1, 16);
