...
#ifndef TURBO_DEBUGGING_INTERNAL_STACKTRACE_X86_INL_INC_
#define TURBO_DEBUGGING_INTERNAL_STACKTRACE_X86_INL_INC_
...
using turbo::debugging_internal::AddressIsReadable;
    ...
    if (WITH_CONTEXT && uc != nullptr) {
      ...
      if (num_push_instructions == -1) {
        ...
        if (vdso.IsPresent()) {
          ...
          turbo::debugging_internal::VDSOSupport::SymbolInfo vsyscall_symbol_info;
...
static int UnwindImpl(void **result, int *sizes, int max_depth, int skip_count,
    ...
    size_t stack_low = turbo::get_page_size();
...
#endif  // TURBO_DEBUGGING_INTERNAL_STACKTRACE_X86_INL_INC_
