...
#elif !defined(TURBO_HAVE_MMAP) && !defined(_WIN32)
...
namespace turbo::base_internal {
    ...
    public:
        ...
        // is not available.
        static void *Alloc(size_t request) TURBO_ATTRIBUTE_SECTION(malloc_hook);

        static void *AllocWithArena(size_t request, Arena *arena)
        TURBO_ATTRIBUTE_SECTION(malloc_hook);
        ...
        static void Free(void *s) TURBO_ATTRIBUTE_SECTION(malloc_hook);

        // TURBO_ATTRIBUTE_SECTION(malloc_hook) for Alloc* and Free
