...
namespace turbo {
    ...
    template<class K, class V,
            class Hash = turbo::container_internal::hash_default_hash<K>,
            class Eq = turbo::container_internal::hash_default_eq<K>,
            class Allocator = std::allocator<std::pair<const K, V>>>
    class flat_hash_map : public turbo::container_internal::raw_hash_map<
            turbo::container_internal::FlatHashMapPolicy<K, V>,
            Hash, Eq, Allocator> {
