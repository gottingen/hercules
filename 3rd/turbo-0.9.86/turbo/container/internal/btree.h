...
// Btree will use the tag's truth value.
    ...
    constexpr bool compare_has_valid_result_type() {
        ...
        return std::is_same<compare_result_type, bool>::value ||
               std::is_convertible<compare_result_type, turbo::weak_ordering>::value;
    }
...
// that the children array is only valid in internal nodes.
    ...
    public:
        ...
        btree(btree &&other) noexcept
                : root_(turbo::exchange(other.root_, EmptyNode())),
                  rightmost_(std::move(other.rightmost_)),
                  size_(turbo::exchange(other.size_, 0u)) {
    ...
    private:
        ...
        turbo::container_internal::CompressedTuple<key_compare, allocator_type,
                node_type *>
                rightmost_;
