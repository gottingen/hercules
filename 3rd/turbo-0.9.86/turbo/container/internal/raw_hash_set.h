...
// of this state to helper functions as a single argument.
    ...
    public:
        ...
        CommonFields(CommonFields &&that)
                ...
                // fields generates less code then calling turbo::exchange per field.
        ...
        turbo::container_internal::CompressedTuple<size_t, HashtablezInfoHandle>
...
#define TURBO_INTERNAL_ASSERT_IS_FULL(ctrl, generation, generation_ptr, \
  ...
  do {                                                                         \
    ...
    public:
        ...
        using pointer = typename turbo::allocator_traits<
                allocator_type>::template rebind_traits<value_type>::pointer;
        using const_pointer = typename turbo::allocator_traits<
    ...
    private:
        ...
        using AllocTraits = turbo::allocator_traits<allocator_type>;
        using SlotAlloc = typename turbo::allocator_traits<
                allocator_type>::template rebind_alloc<slot_type>;
        using SlotAllocTraits = typename turbo::allocator_traits<
    ...
    public:
        ...
        // would create a nullptr functor that cannot be called.
                settings_(turbo::exchange(that.common(), CommonFields{}),
        ...
        turbo::allocator_traits<allocator_type>::is_always_equal::value &&
    ...
    private:
        ...
        friend
        struct turbo::container_internal::hashtable_debug_internal::
        ...
        inline void initialize_slots() {
            ...
            // anyway).
            using CharAlloc =
                    typename turbo::allocator_traits<Alloc>::template rebind_alloc<char>;
    ...
    private:
        ...
        turbo::container_internal::CompressedTuple<CommonFields, hasher, key_equal,
                allocator_type>
