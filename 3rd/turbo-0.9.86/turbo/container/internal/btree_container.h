...
namespace turbo::container_internal {
    ...
    public:
        ...
        btree_container(const btree_container &other)
                : btree_container(other, turbo::allocator_traits<allocator_type>::
        ...
        // Utility routines.
        TURBO_ATTRIBUTE_REINITIALIZES void clear() { tree_.clear(); }
...
// Base class for btree_map.
    ...
    public:
        ...
        mapped_type &at(const key_arg<K> &key) {
            ...
            if (it == this->end())
                base_internal::ThrowStdOutOfRange("turbo::btree_map::at");
            return it->second;
        }
