...
namespace turbo {
    ...
    class node_hash_set
            : public turbo::container_internal::raw_hash_set<
                    turbo::container_internal::NodeHashSetPolicy<T>, Hash, Eq, Alloc> {
    ...
    namespace container_internal {
        ...
        struct NodeHashSetPolicy
            ...
            static T *new_element(Allocator *alloc, Args &&... args) {
                using ValueAlloc =
                        typename turbo::allocator_traits<Allocator>::template rebind_alloc<T>;
                ValueAlloc value_alloc(*alloc);
                T *res = turbo::allocator_traits<ValueAlloc>::allocate(value_alloc, 1);
                turbo::allocator_traits<ValueAlloc>::construct(value_alloc, res,
            ...
            static void delete_element(Allocator *alloc, T *elem) {
                using ValueAlloc =
                        typename turbo::allocator_traits<Allocator>::template rebind_alloc<T>;
                ValueAlloc value_alloc(*alloc);
                turbo::allocator_traits<ValueAlloc>::destroy(value_alloc, elem);
                turbo::allocator_traits<ValueAlloc>::deallocate(value_alloc, elem, 1);
            }
