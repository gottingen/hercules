    ...
    namespace container_internal {
        ...
        struct set_slot_policy {
            ...
            static void construct(Alloc *alloc, slot_type *slot, Args &&...args) {
                turbo::allocator_traits<Alloc>::construct(*alloc, slot,
                                                          std::forward<Args>(args)...);
            }

            template<typename Alloc>
            static void construct(Alloc *alloc, slot_type *slot, slot_type *other) {
                turbo::allocator_traits<Alloc>::construct(*alloc, slot, std::move(*other));
            }

            template<typename Alloc>
            static void construct(Alloc *alloc, slot_type *slot, const slot_type *other) {
                turbo::allocator_traits<Alloc>::construct(*alloc, slot, *other);
            }

            template<typename Alloc>
            static void destroy(Alloc *alloc, slot_type *slot) {
                turbo::allocator_traits<Alloc>::destroy(*alloc, slot);
            }
        };
