...
namespace turbo {
    ...
    // fundamental and Turbo types that support the `turbo::Hash` framework have a
    ...
    //  }
    template<class T, class Hash = turbo::container_internal::hash_default_hash<T>,
            class Eq = turbo::container_internal::hash_default_eq<T>,
            class Allocator = std::allocator<T>>
    class flat_hash_set
            : public turbo::container_internal::raw_hash_set<
                    turbo::container_internal::FlatHashSetPolicy<T>, Hash, Eq, Allocator> {
    ...
    template<class T, class Hash = turbo::container_internal::hash_default_ignore_case_hash<T>,
            class Eq = turbo::container_internal::hash_default_ignore_case_eq<T>,
            class Allocator = std::allocator<T>>
    using  flat_ignore_case_hash_set = flat_hash_set<T, Hash, Eq, Allocator>;
    ...
    namespace container_internal {
        ...
        struct FlatHashSetPolicy {
            ...
            static void construct(Allocator *alloc, slot_type *slot, Args &&... args) {
                turbo::allocator_traits<Allocator>::construct(*alloc, slot,
                                                              std::forward<Args>(args)...);
            }

            template<class Allocator>
            static void destroy(Allocator *alloc, slot_type *slot) {
                turbo::allocator_traits<Allocator>::destroy(*alloc, slot);
            }
