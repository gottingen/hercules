...
namespace turbo {
    ...
    //  }
    template<class Key, class Value,
            class Hash = turbo::container_internal::hash_default_hash<Key>,
            class Eq = turbo::container_internal::hash_default_eq<Key>,
            class Alloc = std::allocator<std::pair<const Key, Value>>>
    class node_hash_map
            : public turbo::container_internal::raw_hash_map<
    ...
    namespace container_internal {
        ...
        public:
            ...
            static value_type *new_element(Allocator *alloc, Args &&... args) {
                using PairAlloc = typename turbo::allocator_traits<
                        Allocator>::template rebind_alloc<value_type>;
                PairAlloc pair_alloc(*alloc);
                value_type *res =
                        turbo::allocator_traits<PairAlloc>::allocate(pair_alloc, 1);
                turbo::allocator_traits<PairAlloc>::construct(pair_alloc, res,
            ...
            static void delete_element(Allocator *alloc, value_type *pair) {
                using PairAlloc = typename turbo::allocator_traits<
                        Allocator>::template rebind_alloc<value_type>;
                PairAlloc pair_alloc(*alloc);
                turbo::allocator_traits<PairAlloc>::destroy(pair_alloc, pair);
                turbo::allocator_traits<PairAlloc>::deallocate(pair_alloc, pair, 1);
            }
