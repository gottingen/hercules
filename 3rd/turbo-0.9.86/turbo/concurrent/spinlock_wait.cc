...
// turbo_internal_spin_lock_delay() and turbo_internal_spin_lock_wake().
...
#if defined(_WIN32)
#include "turbo/concurrent/internal/spinlock_win32.h"
#elif defined(__linux__)

#include "turbo/concurrent/internal/spinlock_linux.h"

#elif defined(__akaros__)
#include "turbo/concurrent/internal/spinlock_akaros.h"
#else
#include "turbo/concurrent/internal/spinlock_posix.h"
#endif
