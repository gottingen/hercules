...
namespace turbo {
    ...
    class EntityFormat {
    public:
        EntityFormat &width(size_t value) {
            width_ = value;
            return *this;
        }

        EntityFormat &height(size_t value) {
            height_ = value;
            return *this;
        }

        EntityFormat &padding(size_t value) {
            padding_left_ = value;
        ...
        EntityFormat &padding_left(size_t value) {
            padding_left_ = value;
            return *this;
        }

        EntityFormat &padding_right(size_t value) {
            padding_right_ = value;
            return *this;
        }

        EntityFormat &padding_top(size_t value) {
            padding_top_ = value;
            return *this;
        }

        EntityFormat &padding_bottom(size_t value) {
            padding_bottom_ = value;
            return *this;
        }

        EntityFormat &border(const std::string &value) {
            border_left_ = value;
            border_right_ = value;
            border_top_ = value;
        ...
        EntityFormat &border_left(const std::string &value) {
            border_left_ = value;
            return *this;
        }
        ...
        EntityFormat &border_right(const std::string &value) {
            border_right_ = value;
            return *this;
        }
        ...
        EntityFormat &border_bottom(const std::string &value) {
            border_bottom_ = value;
            return *this;
        }
        ...
        EntityFormat &show_border_top() {
            show_border_top_ = true;
            return *this;
        }

        EntityFormat &hide_border_top() {
            show_border_top_ = false;
            return *this;
        }

        EntityFormat &show_border_bottom() {
            show_border_bottom_ = true;
            return *this;
        }

        EntityFormat &hide_border_bottom() {
            show_border_bottom_ = false;
            return *this;
        }

        EntityFormat &show_border_left() {
            show_border_left_ = true;
            return *this;
        }

        EntityFormat &hide_border_left() {
            show_border_left_ = false;
            return *this;
        }

        EntityFormat &show_border_right() {
            show_border_right_ = true;
            return *this;
        }

        EntityFormat &hide_border_right() {
            show_border_right_ = false;
            return *this;
        }

        EntityFormat &corner(const std::string &value) {
        ...
        EntityFormat &corner_bottom_left(const std::string &value) {
            corner_bottom_left_ = value;
            return *this;
        }
        ...
        EntityFormat &column_separator(const std::string &value) {
        ...
        EntityFormat &font_align(FontAlign value) {
            font_align_ = value;
            return *this;
        }
        ...
        EntityFormat &multi_byte_characters(bool value) {
            multi_byte_characters_ = value;
            return *this;
        }

        EntityFormat &locale(const std::string &value) {
            locale_ = value;
            return *this;
        }
        ...
        static EntityFormat merge(EntityFormat first, EntityFormat second) {
            EntityFormat result;
