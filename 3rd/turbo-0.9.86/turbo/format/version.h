...
#ifndef TURBO_FORMAT_VERSION_H_
#define TURBO_FORMAT_VERSION_H_
...
namespace turbo {
    ...
    static constexpr turbo::ModuleVersion format_version = turbo::ModuleVersion{0, 9, 38};

}  // namespace turbo
#endif  // TURBO_FORMAT_VERSION_H_
