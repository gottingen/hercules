...
///////////////////////////////////////////////////////////////////////
        ...
        private:
            void pad_it(long count) {
                fmt_helper::append_string_view(std::string_view(spaces_.data(), static_cast<size_t>(count)), dest_);
            }

            const padding_info &padinfo_;
            memory_buf_t &dest_;
            long remaining_pad_;
            std::string_view spaces_{"                                                                ", 64};
        };
        ...
        switch (flag) {
            ...
            default: // Unknown flag appears as is
                ...
                if (!padding.truncate_) {
                    ...
                    // turbo::tlog::set_pattern("[%10!] %v") => "[      main] some message"
                    // turbo::tlog::set_pattern("[%3!!] %v") => "[mai] some message"
                else {
