...
namespace turbo::tlog {
    ...
    template<typename Sink, typename... SinkArgs>
    inline std::shared_ptr<turbo::tlog::logger> create_async(std::string logger_name, SinkArgs &&... sink_args) {
        return async_factory::create<Sink>(std::move(logger_name), std::forward<SinkArgs>(sink_args)...);
    }

    template<typename Sink, typename... SinkArgs>
    inline std::shared_ptr<turbo::tlog::logger> create_async_nb(std::string logger_name, SinkArgs &&... sink_args) {
    ...
    inline std::shared_ptr<turbo::tlog::details::thread_pool> thread_pool() {
