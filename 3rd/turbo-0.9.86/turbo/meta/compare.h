...
// -----------------------------------------------------------------------------
//
// This header file defines the `turbo::weak_equality`, `turbo::strong_equality`,
// `turbo::partial_ordering`, `turbo::weak_ordering`, and `turbo::strong_ordering`
...
#define TURBO_COMPARE_INLINE_SUBCLASS_DECL(type, name) \
...
namespace turbo {
    ...
    public:
        TURBO_COMPARE_INLINE_SUBCLASS_DECL(weak_equality, equivalent);
        TURBO_COMPARE_INLINE_SUBCLASS_DECL(weak_equality, nonequivalent);
    ...
    TURBO_COMPARE_INLINE_INIT(weak_equality, equivalent,
                              compare_internal::eq::equivalent);
    TURBO_COMPARE_INLINE_INIT(weak_equality, nonequivalent,
    ...
    public:
        TURBO_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, equal);
        TURBO_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, nonequal);
        TURBO_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, equivalent);
        TURBO_COMPARE_INLINE_SUBCLASS_DECL(strong_equality, nonequivalent);
    ...
    TURBO_COMPARE_INLINE_INIT(strong_equality, equal, compare_internal::eq::equal);
    TURBO_COMPARE_INLINE_INIT(strong_equality, nonequal,
                              compare_internal::eq::nonequal);
    TURBO_COMPARE_INLINE_INIT(strong_equality, equivalent,
                              compare_internal::eq::equivalent);
    TURBO_COMPARE_INLINE_INIT(strong_equality, nonequivalent,
                              compare_internal::eq::nonequivalent);
...
#undef TURBO_COMPARE_INLINE_INIT
    ...
    constexpr bool cmp_equal(T t, U u) noexcept {
        return compare_internal::cmp_equal_impl(t, u);
    }
    ...
    namespace compare_internal {
        template<
                class T,
                class U,
                std::enable_if_t<compare_internal::same_signedness<T, U>::value, bool> = true
        >
        ...
        template<
                ...
                class U,
                std::enable_if_t<
                        !compare_internal::same_signedness<T, U>::value && std::is_signed<T>::value,
                        bool
                > = true
        >
        constexpr bool cmp_less_impl(T t, U u) noexcept {
    ...
    constexpr bool cmp_less(T t, U u) noexcept {
        return compare_internal::cmp_less_impl(t, u);
    }
