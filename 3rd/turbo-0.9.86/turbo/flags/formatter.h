...
//
#ifndef TURBO_FLAGS_FORMATTER_H_
#define TURBO_FLAGS_FORMATTER_H_
...
namespace turbo {
    ...
    /// about the structure in turbo::Formatter.
    class FormatterBase {
    protected:
        /// @name Options
        ///@{
    ...
    /// This is the default Formatter for flags. It pretty prints help output, and is broken into quite a few
...
#endif  // TURBO_FLAGS_FORMATTER_H_
