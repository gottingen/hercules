...
// The class encapsulates the Flag's data and access to it.
        ...
        private:
            ...
            std::shared_mutex *DataGuard() const
            TURBO_LOCK_RETURNED(reinterpret_cast<std::shared_mutex *>(data_guard_));
            ...
            void StoreValue(const void *src) TURBO_EXCLUSIVE_LOCKS_REQUIRED(*DataGuard());
            ...
            std::unique_ptr<FlagStateInterface> save_state() override
            TURBO_LOCKS_EXCLUDED(*DataGuard());
