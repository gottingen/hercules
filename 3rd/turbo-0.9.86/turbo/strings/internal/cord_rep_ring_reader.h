...
#ifndef TURBO_STRINGS_INTERNAL_CORD_REP_RING_READER_H_
#define TURBO_STRINGS_INTERNAL_CORD_REP_RING_READER_H_
...
#endif  // TURBO_STRINGS_INTERNAL_CORD_REP_RING_READER_H_
