...
#define TURBO_USE_CYCLECLOCK_FOR_GET_CURRENT_TIME_NANOS 1
#else
...
#include "turbo/times/internal/get_current_time_chrono.h"
#else

#include "turbo/times/internal/get_current_time_posix.h"
