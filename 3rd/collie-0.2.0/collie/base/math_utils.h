...
#ifndef COLLIE_BASE_MATH_UTILS_H_
#define COLLIE_BASE_MATH_UTILS_H_
...
#undef R6
    ...
    constexpr inline bool isPowerOf2_32(uint32_t Value) {
        return collie::has_single_bit(Value);
    }
    ...
    inline bool isShiftedMask_32(uint32_t Value, unsigned &MaskIdx,
        ...
        if (!isShiftedMask_32(Value))
            return false;
        MaskIdx = collie::countr_zero(Value);
        MaskLen = collie::popcount(Value);
        return true;
    }
    ...
    template <size_t kValue> constexpr inline size_t CTLog2() {
        static_assert(kValue > 0 && collie::isPowerOf2_64(kValue),
    ...
    inline unsigned Log2_32(uint32_t Value) {
        return 31 - collie::countl_zero(Value);
    }

    /// Return the floor log base 2 of the specified value, -1 if the value is zero.
    /// (64 bit edition.)
    inline unsigned Log2_64(uint64_t Value) {
        return 63 - collie::countl_zero(Value);
    }
    ...
    inline unsigned Log2_32_Ceil(uint32_t Value) {
        return 32 - collie::countl_zero(Value - 1);
    }

    /// Return the ceil log base 2 of the specified value, 64 if the value is zero.
    /// (64 bit edition.)
    inline unsigned Log2_64_Ceil(uint64_t Value) {
        return 64 - collie::countl_zero(Value - 1);
    }
...
#endif  // COLLIE_BASE_MATH_UTILS_H_
