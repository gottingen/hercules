...
#include <collie/cli/error.h>
#include <collie/cli/formatter_fwd.h>
#include <collie/cli/macros.h>
#include <collie/cli/option.h>
#include <collie/cli/split.h>
#include <collie/cli/string_tools.h>
#include <collie/cli/type_tools.h>

namespace collie {

#ifndef COLLIE_CLI_PARSE
#define COLLIE_CLI_PARSE(app, ...)                                                                                          \
    try {                                                                                                              \
    ...
    namespace FailureMessage {
        /// Printout a clean, simple message on error
        inline std::string simple(const App *app, const Error &e);

        /// Printout the full help string on error
...
/// helper functions for adding in appropriate flag modifiers for add_flag
    ...
    public:
        ...
        Option *add_option(std::string option_name,
            ...
            auto fun = [&variable](const collie::results_t &res) {  // comment for spacing
                return detail::lexical_conversion<AssignTo, ConvertTo>(res, variable);
            };

            Option *opt = add_option(option_name, fun, option_description, false, [&variable]() {
                return collie::detail::checked_to_string<AssignTo, ConvertTo>(variable);
            });
        ...
        Option *add_option_function(std::string option_name,
            ...
            auto fun = [func](const collie::results_t &res) {
                ArgType variable;
        ...
        Option *add_option(std::string option_name) {
            return add_option(option_name, collie::callback_t{}, std::string{}, false);
        }
        ...
        Option *add_option(std::string option_name, T &option_description) {
            return add_option(option_name, collie::callback_t(), option_description, false);
        }
    ...
    private:
        ...
        Option *_add_flag_internal(std::string flag_name, collie::callback_t fun, std::string flag_description);

    public:
        /// Add a flag with no description or variable assignment
        Option *add_flag(std::string flag_name) {
            return _add_flag_internal(flag_name, collie::callback_t(), std::string{});
        }
        ...
        Option *add_flag(std::string flag_name, T &flag_description) {
            return _add_flag_internal(flag_name, collie::callback_t(), flag_description);
        }
        ...
        Option *add_flag(std::string flag_name,
            ...
            collie::callback_t fun = [&flag_result](const collie::results_t &res) {
        ...
        Option *add_flag(std::string flag_name,
                         ...
                         std::string flag_description = "") {
            collie::callback_t fun = [&flag_results](const collie::results_t &res) {
                bool retval = true;
        ...
        App *add_subcommand(collie::App_p subcom);
        ...
        collie::App_p get_subcommand_ptr(App *subcom) const;

        /// Check to see if a subcommand is part of this command (text version)
        [[nodiscard]] collie::App_p get_subcommand_ptr(std::string subcom) const;

        /// Get an owning pointer to subcommand by index
        [[nodiscard]] collie::App_p get_subcommand_ptr(int index = 0) const;
...
#include <collie/cli/impl/app_inl.h>
