...
namespace hercules::ast {
    ...
    Stmt::Stmt(const hercules::SrcInfo &s) : done(false), age(-1) { setSrcInfo(s); }
    ...
    const std::string Attr::CppExport = "ccexport";
...
// Search expression tree for a identifier
    ...
    void ClassStmt::parseDecorators() {
        ...
        for (auto &d: decorators) {
            ...
            } else if (d->isId(Attr::CppExport)) {
                attributes.set(Attr::CppExport);
