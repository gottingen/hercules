...
namespace hercules::ast {
    ...
    struct Cache : public std::enable_shared_from_this<Cache> {
        ...
        /// By convention, the key of the Hercules's standard library is "".
        ...
        struct Class {
            ...
            struct ClassRealization {
                ...
                /// IR type pointer.
                hercules::ir::types::Type *ir = nullptr;
        ...
        /// Set if the Hercules is running in JIT mode.
        bool isJit;
        int jitCell;
        ...
        /// Set if Hercules operates in Python compatibility mode (e.g., with Python numerics)
        bool pythonCompat = false;
        /// Set if Hercules operates in Python extension mode
