...
#include <hercules/ast/cc/cpp_static_assert.h>
...
namespace hercules::ccast {
    ...
    namespace {
        ...
        bool generate_file(code_generator &generator, const cpp_file &f,
                           cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(f), cur_access);
            if (output) {
        ...
        bool generate_macro_parameter(code_generator &generator, const cpp_macro_parameter &param,
                                      cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(param), cur_access);
            if (output)
        ...
        bool generate_macro_definition(code_generator &generator, const cpp_macro_definition &def,
                                       cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(def), cur_access);
            if (output) {
        ...
        bool generate_include_directive(code_generator &generator, const cpp_include_directive &include,
                                        cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(include), cur_access);
            if (output) {
        ...
        bool generate_language_linkage(code_generator &generator, const cpp_language_linkage &linkage,
                                       cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(linkage), cur_access);
            if (output) {
        ...
        bool generate_namespace(code_generator &generator, const cpp_namespace &ns,
                                cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(ns), cur_access);
            if (output) {
                if (ns.is_inline())
        ...
        bool generate_namespace_alias(code_generator &generator, const cpp_namespace_alias &alias,
                                      cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(alias), cur_access);
            if (output) {
        ...
        bool generate_using_directive(code_generator &generator, const cpp_using_directive &directive,
                                      cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(directive), cur_access);
            if (output)
        ...
        bool generate_using_declaration(code_generator &generator, const cpp_using_declaration &declaration,
                                        cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(declaration),
                                          cur_access);
            if (output)
        ...
        bool generate_enum_value(code_generator &generator, const cpp_enum_value &value,
                                 cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(value), cur_access);
            if (output) {
        ...
        bool generate_enum(code_generator &generator, const cpp_enum &e,
                           cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(e), cur_access);
            if (output) {
                output << keyword("enum");
                if (e.is_scoped())
        ...
        bool generate_access_specifier(code_generator &generator, const cpp_access_specifier &access,
            ...
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(access),
        ...
        bool generate_base_class(code_generator &generator, const cpp_base_class &base,
            ...
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(base),
        ...
        bool generate_class(code_generator &generator, const cpp_class &c,
                            cpp_access_specifier_kind cur_access,
                            collie::ts::optional_ref<const cpp_template_specialization> spec = nullptr) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(c), cur_access);
            if (output) {
                if (is_friended(c))
        ...
        bool generate_variable(code_generator &generator, const cpp_variable &var,
                               cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(var), cur_access);
            if (output) {
        ...
        bool generate_function(code_generator &generator, const cpp_function &func,
                               cpp_access_specifier_kind cur_access,
                               collie::ts::optional_ref<const cpp_template_specialization> spec = nullptr) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(func), cur_access);
            if (output) {
                if (is_friended(func))
                    output << keyword("friend") << whitespace;
        ...
        bool generate_member_function(code_generator &generator, const cpp_member_function &func,
                                      cpp_access_specifier_kind cur_access,
                                      collie::ts::optional_ref<const cpp_template_specialization> spec
                                      = nullptr) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(func), cur_access);
            if (output) {
                if (is_friended(func))
        ...
        bool generate_conversion_op(code_generator &generator, const cpp_conversion_op &op,
                                    cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(op), cur_access);
            if (output) {
                if (is_friended(op))
                    output << keyword("friend") << whitespace;
                if (op.is_explicit())
        ...
        bool generate_constructor(code_generator &generator, const cpp_constructor &ctor,
                                  cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(ctor), cur_access);
            if (output) {
                if (is_friended(ctor))
                    output << keyword("friend") << whitespace;
                if (ctor.is_explicit())
        ...
        bool generate_destructor(code_generator &generator, const cpp_destructor &dtor,
                                 cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(dtor), cur_access);
            if (output) {
                if (is_friended(dtor))
                    output << keyword("friend") << whitespace;
        ...
        bool generate_class_template(code_generator &generator, const cpp_class_template &templ,
                                     cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(templ), cur_access);
            if (output) {
        ...
        bool generate_class_template_specialization(code_generator &generator,
            ...
            if (output) {
                ...
                generate_class(generator, templ.class_(), cur_access, collie::ts::ref(templ));
            }
            return static_cast<bool>(output);
        }
        ...
        bool generate_concept(code_generator &generator, const cpp_concept &con,
                              cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(con), cur_access);
            if (output) {
                output << keyword("template") << operator_ws << punctuation("<") << bracket_ws;
        ...
        bool generate_static_assert(code_generator &generator, const cpp_static_assert &assert,
                                    cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(assert), cur_access);
            if (output) {
        ...
        bool generate_unexposed(code_generator &generator, const cpp_unexposed_entity &entity,
                                cpp_access_specifier_kind cur_access) {
            code_generator::output output(collie::ts::ref(generator), collie::ts::ref(entity), cur_access);
            if (output) {
...
#undef CPPAST_DETAIL_HANDLE
    ...
    bool generate_code(code_generator &generator, const cpp_entity &e) {
        generator.main_entity_ = collie::ts::ref(e);
