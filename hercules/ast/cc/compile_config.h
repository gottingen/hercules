...
namespace hercules::ccast {
    ...
    /// A [ts::flag_set]() of [hercules::ccast::compile_flag]().
    using compile_flags = collie::ts::flag_set<compile_flag>;

    /// Base class for the configuration of a [hercules::ccast::parser]().
