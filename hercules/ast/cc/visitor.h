...
namespace hercules::ccast {
    ...
    enum visitor_result : bool {
        ...
        /// \notes This only happens when the event is [hercules::ccast::visitor_info::container_entity_enter]().
        continue_visit_no_children = false,

        /// Visit should be aborted.
        /// \notes This only happens when the event is not
        /// [hercules::ccast::visitor_info::container_entity_enter]().
        abort_visit = false,
    };
    ...
    /// Visits a [hercules::ccast::cpp_entity]() and children that pass a given filter.
    ///
    ...
    /// entity and access specifier first and the result converted to [hercules::ccast::visit_filter](). Visit
    /// will behave accordingly.
    ///
    /// \requires The visitor must be as specified for the other overload.
    /// The filter must be a function taking a [hercules::ccast::cpp_entity]() as first parameter and optionally
    /// a [hercules::ccast::cpp_access_specifier_kind]() as second. It must return a `bool` or a
    /// [hercules::ccast::visit_filter]().
