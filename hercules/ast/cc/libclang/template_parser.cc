...
collie::ts::optional<typename TemplateT::builder> get_builder(const detail::parse_context& context,
                                                             ...
                                                             const CXCursor&              parent)
{
    ...
    collie::ts::optional<cpp_token_string> constraint = collie::ts::nullopt;
...
{
    // steal comment
    auto comment = collie::ts::copy(non_template.comment());
    non_template.set_comment(collie::ts::nullopt);
