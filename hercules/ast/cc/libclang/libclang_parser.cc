  ...
  remove_comments_in_macro_(false), use_c_(false)
{
    ...
    define_macro("__cppast_version_major__", std::to_string(HERCULES_VERSION_MAJOR));
    define_macro("__cppast_version_minor__", std::to_string(HERCULES_VERSION_MINOR));
}
...
hercules::ccast::libclang_compile_config::libclang_compile_config(
...
collie::ts::optional<libclang_compile_config> hercules::ccast::find_config_for(
...
int hercules::ccast::libclang_parser::libclang_minor_version()
{
