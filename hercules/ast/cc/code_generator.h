...
namespace hercules::ccast {
    ...
    public:
        ...
        /// \requires `i < length()`.
        char operator[](collie::ts::index_t i) const noexcept {
            return collie::ts::at(str_, i);
        }
    ...
    /// A special [hercules::ccast::string_view]() representing a C++ keyword token.
    using keyword = detail::semantic_string_view<struct keyword_tag>;

    /// A special [hercules::ccast::string_view]() representing a C++ identifier token.
    using identifier = detail::semantic_string_view<struct identifier_tag>;

    /// A special [hercules::ccast::string_view]() representing a C++ string or character literal token.
    using string_literal = detail::semantic_string_view<struct str_literal_tag>;

    /// A special [hercules::ccast::string_view]() representing a C++ integer literal token.
    using int_literal = detail::semantic_string_view<struct int_literal_tag>;

    /// A special [hercules::ccast::string_view]() representing a C++ floating point literal token.
    using float_literal = detail::semantic_string_view<struct float_literal_tag>;

    /// A special [hercules::ccast::string_view]() representing a C++ punctuation token like `.` or `(`.
    using punctuation = detail::semantic_string_view<struct punctuation_tag>;

    /// A special [hercules::ccast::string_view]() representing a C++ preprocessor token.
    using preprocessor_token = detail::semantic_string_view<struct preprocessor_tag>;

    /// A special [hercules::ccast::string_view]() representing a comment.
    using comment = detail::semantic_string_view<struct comment_tag>;

    /// A special [hercules::ccast::string_view]() representing a sequence of unknown C++ tokens.
    ...
    using formatting = collie::ts::flag_set<formatting_flags>;

    /// Base class to control the code generation.
    ///
    /// Inherit from it to customize how a [hercules::ccast::cpp_entity]() is printed
    /// by [hercules::ccast::generate_code]().
    ...
    public:
        ...
        using generation_options = collie::ts::flag_set<generation_flags>;
        ...
        public:
            ...
            explicit output(collie::ts::object_ref<code_generator> gen,
                            collie::ts::object_ref<const cpp_entity> e,
                            hercules::ccast::cpp_access_specifier_kind access)
            ...
            hercules::ccast::formatting formatting() const {
            ...
            collie::ts::object_ref<code_generator> generator() const noexcept {
                return gen_;
            }
        ...
        private:
            collie::ts::object_ref<code_generator> gen_;
            collie::ts::object_ref<const cpp_entity> e_;
    ...
    protected:
        ...
        /// \returns The entity whose code is being generated with [hercules::ccast::generate_code()]().
    ...
    private:
        ...
        /// If an entity is not part of a class the access specifier is alwasy [hercules::ccast::cpp_public]().
        ...
        /// \group write
        virtual bool do_write_reference(collie::ts::array_ref<const cpp_entity_id> id, string_view name) {
            (void) id;
        ...
        collie::ts::optional_ref<const cpp_entity> main_entity_;
