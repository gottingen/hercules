...
namespace hercules::ir::analyze::dataflow {
    ...
    public:
        ...
        auto insert(It it, const Value *v) {
            values.insert(it, v);
            reg(v);
        }
    ...
    public:
        ...
        template<typename It>
        auto insert(It pos, Predecessor v) {
        ...
        template<typename It>
        auto erase(It pos) { return preds.erase(pos); }
