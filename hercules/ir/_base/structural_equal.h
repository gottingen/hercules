...
#include <hercules/ir/_base/cow_array_ref.h>
#include <hercules/ir/_base/cow_map_ref.h>
#include <hercules/ir/_base/object_path.h>
...
class SEqualReducer {
 ...
 private:
  ...
  bool ObjectAttrsEqual(const ObjectRef& lhs,
                        const ObjectRef& rhs,
                        bool map_free_vars,
  ...
  template <typename T>
  static bool CompareAttributeValues(const T& lhs,
                                     const T& rhs,
                                     const PathTracingData* tracing_data);
...
class SEqualHandlerDefault : public SEqualReducer::Handler {
 public:
  SEqualHandlerDefault(bool assert_mode,
 ...
 protected:
   ...
   * \return The equality result.
   */
  virtual bool DispatchSEqualReduce(const ObjectRef& lhs,
                                    const ObjectRef& rhs,
                                    bool map_free_vars,
