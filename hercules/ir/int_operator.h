...
template <>
inline bool WillOverflow<ir::PrimAddNode>(int64_t x,
                                          int64_t y,
                                          int64_t min_value,
                                          int64_t max_value) {
...
template <>
inline bool WillOverflow<ir::PrimSubNode>(int64_t x,
                                          int64_t y,
                                          int64_t min_value,
                                          int64_t max_value) {
  if ((y > 0) && (x < min_value + y))
...
template <>
inline bool WillOverflow<ir::PrimMulNode>(int64_t x,
                                          int64_t y,
                                          int64_t min_value,
                                          int64_t max_value) {
  if (y == 0)
...
template <>
inline bool WillOverflow<ir::PrimModNode>(int64_t x,
                                          int64_t y,
                                          int64_t min_value,
                                          int64_t max_value) {
  return y == 0;
