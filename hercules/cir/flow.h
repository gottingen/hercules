...
namespace hercules::ir {
    ...
    public:
        ...
        auto insert(It pos, Value *v) { return series.insert(pos, v); }
        ...
        template<typename It>
        auto erase(It pos) { return series.erase(pos); }
...
/// Flow representing a try-catch statement.
    ...
    public:
        ...
        template<typename It>
        auto insert(It pos, Catch v) { return catches.insert(pos, v); }
        ...
        template<typename It>
        auto erase(It pos) { return catches.erase(pos); }
...
/// stages are denoted by a separate flag.
    ...
    public:
        ...
        public:
            ...
            template<typename It>
            auto insert(It pos, Value *v) { return args.insert(pos, v); }
            ...
            template<typename It>
            auto erase(It pos) { return args.erase(pos); }
    ...
    public:
        ...
        template<typename It>
        auto insert(It pos, Stage v) { return stages.insert(pos, v); }
        ...
        template<typename It>
        auto erase(It pos) { return stages.erase(pos); }
