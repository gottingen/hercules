...
#define LAMBDA_VISIT(x)                                                                \
  ...
  void visit(hercules::ir::x *v) override {                                               \
    if (childrenFirst)                                                                 \
      processChildren(v);                                                              \
    preHook(v);                                                                        \
    handle(v);                                                                         \
...
namespace hercules::ir::util {
    ...
    public:
        ...
        void visit(hercules::ir::SeriesFlow *v) override {
            if (childrenFirst)
        ...
        virtual void handle(hercules::ir::SeriesFlow *v) {}
    ...
    private:
        ...
        void processSeriesFlowChildren(hercules::ir::SeriesFlow *v) {
            nodeStack.push_back(v);
