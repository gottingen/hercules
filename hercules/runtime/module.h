...
/*!
 * \file matx/runtime/module.h
 * \brief Runtime container of the functions generated by MATXScript,
...
#ifndef MATXSCRIPT_RUNTIME_MODULE_H
#define MATXSCRIPT_RUNTIME_MODULE_H
...
class Module : public ObjectRef {
 public:
   ...
   */
  MATX_DLL static Module LoadFromFile(const String& file_name, const String& format = "");
 ...
 *      matx::runtime::make_object<MyModuleNode>();
 *    return Module(n);
 *  }
 *
 * \endcode
 */
class MATX_DLL ModuleNode : public Object {
 public:
  ...
  //
  MATXSCRIPT_DECLARE_FINAL_OBJECT_INFO(ModuleNode, Object);
...
constexpr const char* library_module_ctx = "__matxscript_module_ctx";
/*! \brief Placeholder for the module's entry function. */
constexpr const char* library_func_array = "__matxscript_func_array__";
constexpr const char* library_func_registry = "__matxscript_func_registry__";
/*! \brief Placeholder for the module's closures names. */
constexpr const char* library_closures_names = "__matxscript_closures_names__";
}  // namespace symbol
...
#endif  // MATXSCRIPT_RUNTIME_MODULE_H
