 ...
 * https://github.com/python/cpython/blob/3.8/Objects/unicodectype.c
 *
...
gettyperecord(Py_UCS4 code) noexcept
{
    int index;
...
Py_UCS4 _PyUnicode_ToTitlecase(Py_UCS4 ch) noexcept
{
...
int _PyUnicode_IsTitlecase(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsXidStart(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsXidContinue(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_ToDecimalDigit(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsDecimalDigit(Py_UCS4 ch) noexcept
{
...
int _PyUnicode_ToDigit(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsDigit(Py_UCS4 ch) noexcept
{
...
int _PyUnicode_IsNumeric(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
*/
int _PyUnicode_IsPrintable(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsLowercase(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsUppercase(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
Py_UCS4 _PyUnicode_ToUppercase(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
Py_UCS4 _PyUnicode_ToLowercase(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_ToLowerFull(Py_UCS4 ch, Py_UCS4 *res) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_ToTitleFull(Py_UCS4 ch, Py_UCS4 *res) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_ToUpperFull(Py_UCS4 ch, Py_UCS4 *res) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_ToFoldedFull(Py_UCS4 ch, Py_UCS4 *res) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsCased(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsCaseIgnorable(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
...
int _PyUnicode_IsAlpha(Py_UCS4 ch) noexcept
{
    const _PyUnicode_TypeRecord *ctype = gettyperecord(ch);
